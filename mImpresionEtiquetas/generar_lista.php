...
$cadena_consulta  = "SELECT codigo, cantidad FROM detalle_solicitud WHERE id_solicitud = '$id_solicitud' AND cantidad > 0";
...
// 	error_reporting(E_ALL);
	...
	//Rename worksheet
	$objPHPExcel->getActiveSheet()->setTitle('Importador de etiquetas');
	...
	header('Content-Disposition: attachment;filename="Listado de etiquetas" '.$fecha.' ".xlsx"');
