...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="index.php"><i class="fa fa-bars"></i> <span>Pendientes de Imprimir</span></a></li>
        <li><a href="impresos.php"><i class="fa fa-bars"></i> <span>Impresas</span></a></li>
        <li class=""><a href="bitacora.php"><i class="fa fa-bars"></i> <span>Bitácora</span></a></li>
        <li class=""><a href="resultados.php"><i class="fa fa-bar-chart"></i> <span>Grafica</span></a></li>
        <li class="active"><a href="resumen_fechas.php"><i class="fa fa-bars"></i> <span>Resumen</span></a></li>
      </ul>
      <ul class="sidebar-menu" data-widget="tree">
