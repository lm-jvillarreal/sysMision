...
include '../global_seguridad/verificar_sesion.php';
    ...
    $qry = "SELECT captura.id FROM inv_captura captura WHERE captura.id_detalle_mapeo = '$id_detalle'";
    $exQry = mysqli_query($conexion, $qry);
    $num = mysqli_num_rows($exQry);

    if ($num >= 1) {
    	$up = "UPDATE inv_captura SET cantidad = $cantidad WHERE captura.id_detalle_mapeo = $id_detalle";
