...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="index.php"><i class="fa fa-bars"></i> <span>Nueva Orden de Compra</span></a></li>
        <li><a href="ordenes_pendientes.php"><i class="fa fa-bars"></i> <span>Mis Órdenes pendientes</span></a></li>
        <li><a href="resumen_oc.php"><i class="fa fa-bars"></i> <span>Resumen Ordenes de Compra</span></a></li>
      </ul>
      <ul class="sidebar-menu" data-widget="tree">
