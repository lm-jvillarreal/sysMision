...
<!-- ./wrapper -->
<?php include '../footer.php'; include 'modal_comentario.php'; include 'modal_rublo.php';?>
<!-- Page script -->
  ...
  function editar(id){
    $.ajax({
      ...
      success: function(respuesta) {
        ...
        $("#id_sucursal").select2("trigger", "select", {
          data: { id: array[10], text:array[11] }
        });
      }
    });
  }
