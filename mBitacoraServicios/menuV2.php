...
?>
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class=""><a href="index.php"><i class="fa fa-dollar"></i> <span>Registro de Servicios</span></a></li>
      <li class="active"><a href="servicios.php"><i class="fa fa-money"></i> <span>Pago de Servicios</span></a></li>
