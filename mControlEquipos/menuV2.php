...
<section class="sidebar">
  ...
  <ul class="sidebar-menu" data-widget="tree">
    ...
    <li class="active"><a href="marcas.php"><i class="fa fa-bars"></i> <span>Registro Marcas</span></a></li>
    <li class=""><a href="modelos.php"><i class="fa fa-bars"></i> <span>Registro Modelos</span></a></li>
