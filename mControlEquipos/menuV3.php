...
<section class="sidebar">
  ...
  <ul class="sidebar-menu" data-widget="tree">
    ...
    <li class=""><a href="index.php"><i class="fa fa-bars"></i> <span>Terminales</span></a></li>
    <li class=""><a href="marcas.php"><i class="fa fa-bars"></i> <span>Registro Marcas</span></a></li>
    <li class="active"><a href="modelos.php"><i class="fa fa-bars"></i> <span>Registro Modelos</span></a></li>
