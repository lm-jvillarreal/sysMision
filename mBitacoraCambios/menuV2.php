...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="header">Bitácora de Cambios</li>
        <li><a href="index.php"><i class="fa fa-bars"></i> <span>Registro</span></a></li>
        <li class="active"><a href="tabla_bitacora.php"><i class="fa fa-bars"></i> <span>Bitácora</span></a></li>
        <li><a href="resumen.php"><i class="fa fa-bar-chart"></i> <span>Resumen</span></a></li>
      </ul>
      <ul class="sidebar-menu" data-widget="tree">
