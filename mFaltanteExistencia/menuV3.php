...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="index.php"><i class="fa fa-bars"></i> <span>Generar Reporte</span></a></li>
        <li><a href="revision_faltantes.php"><i class="fa fa-bars"></i> <span>Revisión</span></a></li>
        <li  class="active"><a href="bitacora_revisiones.php"><i class="fa fa-bars"></i> <span>Bitácora</span></a></li>
      </ul>
      <ul class="sidebar-menu" data-widget="tree">
