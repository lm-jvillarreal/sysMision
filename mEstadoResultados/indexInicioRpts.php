...
<body class="hold-transition skin-red sidebar-mini">
	<div class="wrapper">
								...
								<table id="tablaReportesConsolidados" class="table table-bordered">
									...
									<tbody>
										<tr>
											...
											<th><button type="button" id="ERD001" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#modal-mERD001"><i class="fa fa-file-excel-o" aria-hidden="true"></i></button></th>
										</tr>
									</tbody>									
								</table>
							</div>
		...
		<?php include './modals/modalsReportes/modalERD001.php' ?>
	...
	<script>
		...
		// FUNCIONES MODAL 6
			$(document).ready(function() {
			$("#sucursal_ERD001").select2({
				dropdownParent: $("#modal-mERD001"),
				width: '100%',
