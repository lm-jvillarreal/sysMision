...
$cadena_consulta  = "SELECT detalle.codigo_producto 
FROM inv_detalle_mapeo as detalle
INNER JOIN inv_mapeo as mapeo ON detalle.id_mapeo = mapeo.id
where mapeo.activo = '1'
AND mapeo.completo = '1'
AND mapeo.id_sucursal='$id_sede'
AND (mapeo.fecha >= '$fechaInicio' AND mapeo.fecha <= '$fechaFin')";
