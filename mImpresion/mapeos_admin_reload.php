...
<div class="table-responsive">
	<table id="exampledos" class="table table-striped table-bordered" cellspacing="0" width="100%">
		<thead>
			<tr>
				<th>Area</th>
				<th>Zona</th>
					...
					<td align="center">
						<div class="checkbox">
							<label><input id="impreso" <?php if ($row[5] == 1) {
																					...
																					} ?> name="impreso" value="<?php echo $row[0]; ?>" type="checkbox" onclick="cambiar_estado(<?php echo $row[0]; ?>);"></label>
						</div>
					</td>
				</tr>
			<?php
