...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="../mRegistroIncidencias/index.php"><i class="fa fa-bars"></i> <span>Registro de Incidencias</span></a></li>
        <li class="active"><a href="../mRegistroIncidencias/lista_autorizados.php"><i class="fa fa-bars"></i> <span>Incidencias Autorizadas</span></a></li>
        <li class="active"><a href=""><i class="fa fa-bars"></i> <span>Incidencias Pendientes</span></a></li>
        <li class="active"><a href="../mRegistroIncidencias/lista_rechazados.php"><i class="fa fa-bars"></i> <span>Incidencias Rechazadas</span></a></li>
        <li class="active"><a href="../mRegistroIncidencias/registros.php"><i class="fa fa-bars"></i> <span>Incidencias</span></a></li>
