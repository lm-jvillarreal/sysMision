...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="index.php"><i class="fa fa-bars"></i> <span>Faltantes</span></a></li>
        <li><a href="artc_espera.php"><i class="fa fa-bars"></i> <span>En Transito</span></a></li>
