...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="lista_acumulados.php"><i class="fa fa-bars"></i> <span>Acumulado</span></a></li>
        <li class="active"><a href="lista_coincidencias.php"><i class="fa fa-bars"></i> <span>Histórico</span></a></li>
      </ul>
      <ul class="sidebar-menu" data-widget="tree">
