...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class=""><a href="index.php"><i class="fa fa-clock-o"></i> <span>Control Tiempo</span></a></li>
        <li class="active"><a href="historico.php"><i class="fa fa-history"></i> <span>Historico</span></a></li>
      </ul>
      <ul class="sidebar-menu" data-widget="tree">
