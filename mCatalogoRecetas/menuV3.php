...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="index.php"><i class="fa fa-bars"></i> <span>Registro de recetas</span></a></li>
        <li class="active"><a href="detalle_receta.php"><i class="fa fa-bars"></i> <span>Detalle de receta</span></a></li>
