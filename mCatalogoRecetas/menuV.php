...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="index.php"><i class="fa fa-bars"></i> <span>Registro de recetas</span></a></li>
        <li><a href="detalle_receta.php"><i class="fa fa-bars"></i> <span>Detalle de receta</span></a></li>
        <li><a href="resumen_recetas.php"><i class="fa fa-bars"></i> <span>Resumen de recetas</span></a></li>
      </ul>
      <ul class="sidebar-menu" data-widget="tree">
