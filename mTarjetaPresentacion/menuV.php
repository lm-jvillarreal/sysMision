...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="../mMisDatos/index.php"><i class="fa fa-bars"></i> <span>Modificar Mis Datos</span></a></li>
        <li><a href="../mMisDatos/cambiar_fotografia.php"><i class="fa fa-bars"></i> <span>Cambiar Fotografía</span></a></li>
        <li><a href="../mMisDatos/cambiar_sucursal.php"><i class="fa fa-bars"></i> <span>Cambiar Sucursal</span></a></li>
        <li class="active"><a href="../mTarjetaPresentacion/index.php"><i class="fa fa-bars"></i> <span>Generar VCard</span></a></li>
      </ul>
      <ul class="sidebar-menu" data-widget="tree">
