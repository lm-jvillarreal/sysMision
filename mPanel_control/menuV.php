    ...
    <section class="sidebar">
      ...
      <div class="sidebar-form">
       ...
       <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="index.php"><i class="fa fa-dashboard"></i> <span>Panel de Control</span></a></li>
      </ul>
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="../mCumpleanios/index.php"><i class="fa fa-birthday-cake"></i> <span>Cumpleaños de <?php echo $mes_letra; ?></span></a></li>
