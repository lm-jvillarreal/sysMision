...
?>
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li><a href="index.php"><i class="fa fa-bars"></i> <span>Auditorías</span></a></li>
      <li class="active"><a href="categorias.php"><i class="fa fa-bars"></i> <span>Categorías</span></a></li>
      <li><a href="vigilantes.php"><i class="fa fa-bars"></i> <span>Vigilantes</span></a></li>
      <li><a href="areas.php"><i class="fa fa-bars"></i> <span>Áreas</span></a></li>
    </ul>
    <ul class="sidebar-menu" data-widget="tree">
