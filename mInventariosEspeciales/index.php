...
<body class="hold-transition skin-red sidebar-mini">
      ...
      <section class="content">
        <div class="box box-danger">
          <div class="box-header">
            <h3 class="box-title">Inventarios Especiales | Auditorías</h3>
          </div>
          <div class="box-body">
            <div class="row">
              <div class="col-md-12">
  ...
  <script>
    ...
    function recontar(renglon) {
      var url = "reconteo_articulo.php";
      $.ajax({
        type: "POST",
        url: url,
        data: {
        ...
        success: function(respuesta) {
          if (respuesta == "ok") {
            tabla_auditorias();
            alertify.success("Articulo reagendado nuevamente");
          }
        }
      });
    }
