...
?>
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li><a href="categorias.php"><i class="fa fa-bars"></i> <span>Categorías</span></a></li>
      <li class="active"><a href="vigilantes.php"><i class="fa fa-bars"></i> <span>Vigilantes</span></a></li>
