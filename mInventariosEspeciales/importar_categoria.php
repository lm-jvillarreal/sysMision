...
$cadena_folio = "SELECT IFNULL(MAX(folio),0)+1 FROM vidvig_categorias";
 ...
 if(in_array($_FILES["file"]["type"],$allowedFileType)){
  ...
  $ruta = "formatos/" . $_FILES['file']['name'];
	...
	for($i=0;$i<$sheetCount;$i++){
        ...
        $cadena_insertar = "INSERT INTO vidvig_categorias (FOLIO, CATEGORIA, ARTC_ARTICULO, ARTC_DESCRIPCION, FECHAHORA, ACTIVO, USUARIO)VALUES('$folio_registro', '$nombre_categoria', '$Row[0]', '$descripcion', '$fechahora', '1', '$id_usuario')";
