...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="index.php"><i class="fa fa-bars"></i> <span>Catálogo de cortes</span></a></li>
        ...
        <li  class="active"><a href="bitacora_costeos.php"><i class="fa fa-bars"></i> <span>Bitácora Costeos</span></a></li>
      </ul>
      <ul class="sidebar-menu" data-widget="tree">
