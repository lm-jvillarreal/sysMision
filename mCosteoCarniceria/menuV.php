...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="index.php"><i class="fa fa-bars"></i> <span>Catálogo de cortes</span></a></li>
        <li><a href="costeo.php"><i class="fa fa-bars"></i> <span>Costeo</span></a></li>
        <li><a href="resumen_costeo.php"><i class="fa fa-bars"></i> <span>Resumen Costeos</span></a></li>
        <li><a href="bitacora_costeos.php"><i class="fa fa-bars"></i> <span>Bitácora Costeos</span></a></li>
      </ul>
      <ul class="sidebar-menu" data-widget="tree">
