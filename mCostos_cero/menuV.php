...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="index.php"><i class="fa fa-bars"></i> <span>Insertar Registro</span></a></li>
        <li><a href="bitacora.php"><i class="fa fa-bars"></i> <span>Bitacora</span></a></li>
