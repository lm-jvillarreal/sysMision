...
$cadena = "SELECT t.tran_id_consecutivo, t.almn_almacen, t.tran_folio_entrada, t.tran_almacen_destino, TO_CHAR(t.trad_fecha_aut_entrada,'YYYY/MM/DD'), r.rtrn_cantidad_entrada
...
AND t.trad_fecha_aut_entrada>= TRUNC(TO_DATE('$fecha_inicial', 'YYYY/MM/DD'))
AND t.trad_fecha_aut_entrada < TRUNC(TO_DATE('$fecha_final', 'YYYY/MM/DD') ) + 1
