...
<section class="sidebar">
  ...
  <ul class="sidebar-menu" data-widget="tree">
    ...
    <li class=""><a href="index.php"><i class="fa fa-vcard"></i> <span>Registro Promotores</span></a></li>
    ...
    <li class="active"><a href="grafica2.php"><i class="fa fa-bar-chart"></i> <span>Grafica Promedio Horas</span></a></li>
  </ul>
  <ul class="sidebar-menu" data-widget="tree">
