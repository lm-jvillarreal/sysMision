...
<section class="sidebar">
  ...
  <ul class="sidebar-menu" data-widget="tree">
    ...
    <li class="active"><a href="index.php"><i class="fa fa-vcard"></i> <span>Registro Promotores</span></a></li>
    <li class=""><a href="bitacora.php"><i class="fa fa-history"></i> <span>Bitacora</span></a></li>
    <li class=""><a href="grafica.php"><i class="fa fa-bar-chart"></i> <span>Grafica Cajas Surtidas</span></a></li>
    <li class=""><a href="grafica2.php"><i class="fa fa-bar-chart"></i> <span>Grafica Participacion</span></a></li>
    <!-- <li class=""><a href="calendario.php"><i class="fa fa-bars"></i> <span>Calendario Promotores</span></a></li> -->
  </ul>
  <ul class="sidebar-menu" data-widget="tree">
