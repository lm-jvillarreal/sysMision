...
?> 
 <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="index.php"><i class="fa fa-bars"></i> <span>Resumen de aportaciones.</span></a></li>
        <li class="active"><a href="registro_aportaciones.php"><i class="fa fa-bars"></i> <span>Aportaciones en especie.</span></a></li>
        ...
        <li><a href="comparativo_pa.php"><i class="fa fa-bars"></i> <span>Comparativo P/A</span></a></li>
