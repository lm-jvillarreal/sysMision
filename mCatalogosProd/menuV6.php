    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="importador.php"><i class="fa fa-bars"></i> <span>Importador</span></a></li>
        <li class="active"><a href="editar_catalogo.php"><i class="fa fa-bars"></i> <span>Editar Catálogo</span></a></li>
      </ul>
      <ul class="sidebar-menu" data-widget="tree">
