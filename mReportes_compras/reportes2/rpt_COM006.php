...
//$tipo = $_POST['tipo'];
$sucursal = $_POST['sucursal_COM006'];
//$proveedor = $_POST['proveedor_COM006'];
$codigo = $_POST['codigo'];
$folio = $_POST['folio'];
$tipo = $_POST['tipo_COM006'];
$departamento = $_POST['departamento_COM006'];
$familia = $_POST['familia_COM006'];
