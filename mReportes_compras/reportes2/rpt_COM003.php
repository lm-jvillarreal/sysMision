...
$sucursal = $_POST['sucursal_COM003'];
$proveedor = $_POST['proveedor_COM003'];
...
$departamento = $_POST['departamento_COM003'];
if ($departamento == "") {
	$filtro_departamento = "";
}else{
...
$objPHPExcel->getActiveSheet()
	...
	header('Content-Disposition: attachment;filename="reporte_ofertas_' . $fecha . '.xlsx"');
