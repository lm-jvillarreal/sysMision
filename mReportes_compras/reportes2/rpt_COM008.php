...
$fecha = date('Y-m-d');
$hora = date('H:i:s');
$sucursal = $_POST['sucursal_COM008'];
$fecha_inicial = $_POST['fecha_inicial'];
$fecha_final = $_POST['fecha_final'];
$familia = $_POST['familia_COM008'];
$departamento = $_POST['departamento_COM008'];
...
$consulta_principal  = "SELECT DISTINCT
	...
	header('Content-Disposition: attachment;filename="rpt_analisis_' . $fecha . '.xlsx"');
