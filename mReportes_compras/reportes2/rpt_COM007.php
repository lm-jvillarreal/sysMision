...
$fecha = date('Y-m-d');
$hora = date('H:i:s');
$sucursal = $_POST['sucursal_COM007'];
$familia = $_POST['familia_COM007'];
$array = $_POST['array'];
$arra = explode(',', $array);
$cantidad = count($arra);
$departamento = $_POST['departamento_COM007'];
$or="";
...
if ($familia != "") {
	...
	header('Content-Disposition: attachment;filename="existencias_' . $sucursal . '.xlsx"');
