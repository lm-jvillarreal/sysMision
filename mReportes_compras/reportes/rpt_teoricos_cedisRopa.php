...
$consulta_principal  = "SELECT 
                            ...
                            (
                            SELECT 
                                spin_articulos.fn_existencia_disponible_todos ( 13, NULL, NULL, 1, 1, 203, COM_ARTICULOS.ARTC_ARTICULO)
                            FROM 
                                dual
                            ) CEDIS_ROPA,
	...
	header('Content-Disposition: attachment;filename="REPCOM_ExiSuc_CEDISRopa'.date('Ymd').'.xlsx"');
