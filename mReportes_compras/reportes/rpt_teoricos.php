...
$consulta_principal  = "SELECT 
                            ...
                            (SELECT 
                                    ...
                                    FROM 
                                        dual) PET,
							(SELECT 
                                        spin_articulos.fn_existencia_disponible_todos ( 13, NULL, NULL, 1, 1, 6, COM_ARTICULOS.ARTC_ARTICULO)
                                    FROM 
                                        dual) MMORELOS,
                            (SELECT 
	...
	header('Content-Disposition: attachment;filename="REPCOM_ExiSuc_ARTACT'.date('Ymd').'.xlsx"');
