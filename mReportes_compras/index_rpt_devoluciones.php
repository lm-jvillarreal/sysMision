    ...
    <section class="content">
        <div class="box box-danger">
          <div class="box-header">
            <h3 class="box-title">Reportes | Devoluciones</h3>
          </div>
          <div class="box-body">
            <form method="POST" id="frmDatosComprasVsVentas" action="reportes/general.php">
            <div class="row">
              <div class="col-lg-3">
            ...
            <div class="row">
              <div class="col-lg-3">
                ...
                <select class="form-control" name="tipo">
                  ...
                  <option value="DMPROV">Devolucion Masiva</option>
                  <option value="DEVPRO">Devolucion a proveedor</option>
                  <option value="DEVXCO">Devolucion por correccion</option>
                </select>
              </div>
            </div>
