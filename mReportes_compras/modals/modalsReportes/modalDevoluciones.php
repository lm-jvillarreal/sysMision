<div class="modal fade" id="modal-Devoluciones" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div>
                    <h4 class="modal-title" id="exampleModalLabel">Reporte | Devoluciones</h4>
                </div>
            </div>
            <div class="modal-body" style="max-height: calc(200vh - 110px); overflow-y: auto;">
                <form method="POST" id="COM002">
                    <div class="row">
                        <div class="col-lg-3">
                            <label for="sucursal_COM002">*Sucursal:</label>
                            <select class="form-control select" name="sucursal_COM002" id="sucursal_COM002">
                                <option value=""></option>
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                                <label for="proveedor_COM002">Proveedor:</label>
                                <select name="proveedor_COM002" id="proveedor_COM002" class="form-control select2 no-validar">
                                    <option value=""></option>
                                </select>
                            </div>
                        </div>                        
                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="form-group">
                                <label for="tipo_COM002">*Tipo de devolución:</label>               
                                <select class="form-control select select2" name="tipo_COM002" id="tipo_COM002">
                                    <option value=""></option>
                                    <option value="DMPROV">Devolución Masiva</option>
                                    <option value="DEVPRO">Devolución a proveedor</option>
                                    <option value="DEVXCO">Devolución por correccion</option>
                                </select>
                            </div>
                        </div>                            
                    </div>
                    <div class="text-right">
                        <button type="button" class="btn btn-danger" id="btn_COM002" onclick="generarReporte(this)">Descargar Reporte</button>
                    </div>                 
                </form>
            </div>
        </div>
