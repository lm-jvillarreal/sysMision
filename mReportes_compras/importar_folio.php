...
$cadena_folio = "SELECT IFNULL(MAX(FOLIO),0)+1 FROM com_kardexMovimientos";
 ...
 if(in_array($_FILES["file"]["type"],$allowedFileType)){
  ...
  $ruta = "formatos/" . $_FILES['file']['name'];
	...
	for($i=0;$i<$sheetCount;$i++){
        ...
        $cadena_insertar = "INSERT INTO com_kardexMovimientos (FOLIO, FOLIO_FECHAINICIO, FOLIO_FECHAFIN, FOLIO_SUCURSAL, ARTC_ARTICULO, ARTC_DESCRIPCION, FECHAHORA_FOLIO, ACTIVO, USUARIO)VALUES('$folio_registro','$fecha_inicial','$fecha_final','$sucursal','$Row[0]','$descripcion','$fechahora_folio','1','$id_usuario')";
