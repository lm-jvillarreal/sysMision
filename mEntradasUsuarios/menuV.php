...
<section class="sidebar">
  ...
  <ul class="sidebar-menu" data-widget="tree">
    ...
    <li class="active"><a href="index.php"><i class="fa fa-ravelry"></i> <span>Monitoreo Sistemas</span></a></li>
    <li class=""><a href="entradas_usuario.php"><i class="fa fa-users"></i> <span>Entradas por Usuario</span></a></li>
    <li class=""><a href="movimientos.php"><i class="fa fa-arrows-h"></i> <span>Movimientos por Usuario</span></a></li>
    <li class=""><a href="resultados.php"><i class="fa fa-star-o"></i> <span>Resultados</span></a></li>
    <li class=""><a href="inventarios.php"><i class="fa fa-archive"></i> <span>Participación Inventarios</span></a></li>
  </ul>
  <ul class="sidebar-menu" data-widget="tree">
