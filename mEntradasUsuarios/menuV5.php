...
<section class="sidebar">
  ...
  <ul class="sidebar-menu" data-widget="tree">
    ...
    <li class=""><a href="index.php"><i class="fa fa-ravelry"></i> <span>Monitoreo Sistemas</span></a></li>
    ...
    <li class="active"><a href="inventarios.php"><i class="fa fa-archive"></i> <span>Participación Inventarios</span></a></li>
  </ul>
  <ul class="sidebar-menu" data-widget="tree">
