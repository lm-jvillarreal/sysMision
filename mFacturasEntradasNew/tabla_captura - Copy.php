       ...
       <?php
          ...
          ?>
            <tr>
              ...
              <td align="center">
                <?php echo "$row[2]"; ?>
                <input type="hidden" id="cantidad_<? echo $n;?>" value="<?php echo $row[2] ?>">
              </td>
              <td align="center" width="10%">
                <input value="<?php echo $row_d[3] ?>" type="text" onblur="calcular($('#cantidad_<? echo $n;?>').val(), $(this).val(), <?php echo $n ?>, '<?php echo $row[0] ?>', <?php echo $id_nota ?>, '<?php echo $row[1] ?>')" class="form-control">
              </td>
              <td width="10%">
                <input readonly value= "<?php echo $row_d[4] ?>" type="text" id="total_<? echo $n ?>" class="form-control">
              </td>
            </tr>
            <?
          $n++;
