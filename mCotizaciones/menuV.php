...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="index.php"><i class="fa fa-contao"></i> <span>Registro de Cotizaciones</span></a></li>
        <!-- <li><a href='#' data-id = '1' data-toggle = 'modal' data-target = '#modal-default' target='blank'><i class="fa fa-universal-access"></i><span>Preferencias</span></a></li> -->
      </ul>
      <ul class="sidebar-menu" data-widget="tree">
