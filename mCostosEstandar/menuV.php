...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="index.php"><i class="fa fa-bars"></i> <span>Exportar lista</span></a></li>
        <li><a href="iomportar_cambio.php"><i class="fa fa-bars"></i> <span>Importar Cambio</span></a></li>
      </ul>
      <ul class="sidebar-menu" data-widget="tree">
