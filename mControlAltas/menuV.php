...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="index.php"><i class="fa fa-plus"></i> <span>Registro de Productos</span></a></li>
        <li class=""><a href="procesadas.php"><i class="fa fa-clock-o"></i> <span>Productos en Proceso</span></a></li>
        <li class=""><a href="liberados.php"><i class="fa fa-check"></i> <span>Productos Liberados</span></a></li>
      </ul>
      <ul class="sidebar-menu" data-widget="tree">
