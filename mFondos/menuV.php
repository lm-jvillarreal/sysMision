...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="index.php"><i class="fa fa-bars"></i> <span>Resumen de Fondos</span></a></li>
        <li><a href="escarg_registro.php"><i class="fa fa-bars"></i> <span>Entrada sin cargo</span></a></li>
