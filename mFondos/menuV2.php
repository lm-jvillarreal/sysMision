...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="index.php"><i class="fa fa-bars"></i> <span>Resumen de Fondos</span></a></li>
        <li class="active"><a href="escarg_registro.php"><i class="fa fa-bars"></i> <span>Entrada sin cargo</span></a></li>
        <li><a href="nc_registro.php"><i class="fa fa-bars"></i> <span>Nota de Cargo</span></a></li>
      </ul>
      <ul class="sidebar-menu" data-widget="tree">
