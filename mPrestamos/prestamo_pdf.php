<?php
$id = $_GET["id"];
$conexion=mysqli_connect("200.1.1.178","root","Xoops1991","sysadmision2");
mysqli_set_charset($conexion, "utf8");
$cadena = "SELECT id,
                ( SELECT nombre FROM sucursales WHERE sucursales.id = prestamos.id_sucursal ),
                persona,
                DATE_FORMAT(fecha_entrega, '%d-%m-%Y')
            FROM prestamos
            WHERE id = '$id'";
...
$html="
<br><br>
<h2 style='text-align:center;'>Préstamo</h2>
";
...
$cadena_detalle = "SELECT codigo_interno, 
...
while ($row_detalle = mysqli_fetch_array($consulta_detalle)) {
	...
	<tr>
        ...
        <td align=\"left\"> $row_detalle[2]</td>
	</tr>
	";
