...
<section class="sidebar">
  ...
  <ul class="sidebar-menu" data-widget="tree">
    ...
    <li class=""><a href="index.php"><i class="fa fa-plus"></i> <span>Realizar Préstamo</span></a></li>
    <li class="active"><a href="liberar.php"><i class="fa fa-check-circle"></i> <span>Liberar Préstamo</span></a></li>
