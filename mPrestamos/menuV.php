...
<section class="sidebar">
  ...
  <ul class="sidebar-menu" data-widget="tree">
    ...
    <li class="active"><a href="index.php"><i class="fa fa-plus"></i> <span>Realizar Préstamo</span></a></li>
    <li class=""><a href="liberar.php"><i class="fa fa-check-circle"></i> <span>Liberar Préstamo</span></a></li>
    <li class=""><a href="liberados.php"><i class="fa fa-check"></i> <span>Préstamos Liberados</span></a></li>
  </ul>
  <ul class="sidebar-menu" data-widget="tree">
