...
$objPHPExcel->getProperties()->setCreator("Josué Villarreal")
								...
								->setTitle("Reporte Compras Vs. Ventas")
								->setSubject("Reportes de Operaciones")
								->setDescription("Reporte Compras Vs. Ventas")
...
///////////////Diaz ordaz/////////////////////////////////
	...
	if ($row_ventas_DO[0] == "") {
		...
		$ventas_do = $row_ventas_DO[0]-$dev_do;
...
////////////////Arboledas///////////////////////////////////////
	...
	if ($row_ventas_ARB[0] == "") {
		...
		$ventas_arb = $row_ventas_ARB[0]-$dev_arb;
...
//////////////////////Villegas////////////////////
	...
	if ($row_ventas_VIL[0] == "") {
		...
		$ventas_vil = $row_ventas_VIL[0]-$dev_vill;
...
////////////Allende////////////////
	...
	if ($row_ventas_ALL[0] == "") {
		...
		$ventas_all = $row_ventas_ALL[0]-$dev_all;
