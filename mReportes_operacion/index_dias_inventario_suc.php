    ...
    <section class="content">
        <div class="box box-danger">
          <div class="box-header">
            <h3 class="box-title">Reportes | Días de inventario p/sucursal</h3>
          </div>
          <div class="box-body">
            <form method="POST" id="form_datoss" action="reportes/rpt_dias_sucursal.php">
            <div class="row">
              <div class="col-md-3">
              ...
              <div class="col-md-3">
                ...
                <input type="hidden" id="array_compras_vs" name="array">
              </div>
            </div>
            <div class="row">
              <div class="col-md-3">
          ...
          <div class="box-footer text-right">
            ...
            <a href="javascript:subir_excel($('#form_datoss').attr('id'), $('#array_compras_vs').attr('id'))" class="btn btn-danger">Subir</a>
