    ...
    <section class="content">
        <div class="box box-danger">
          <div class="box-header">
            <h3 class="box-title">Reportes | Coincidencias p/codigo</h3>
          </div>
          <div class="box-body">
            <form method="POST" id="form_datoss" action="reportes/rpt_coincidencias.php">
            <div class="row">
              <div class="col-md-3">
              ...
              <div class="col-md-3">
                <div class="form-group">
                  <label>Codigo</label>
                  <input type="" name="codigo" class="form-control">
                </div>
              </div>
            </div>
          </div>
