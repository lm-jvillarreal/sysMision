      ...
      <section class="content">
        <div class="box box-danger">
          <div class="box-header">
            <h3 class="box-title">Reportes | Faltantes y sobrantes</h3>
          </div>
          <div class="box-body">
            <form method="POST" id="frmDatos" action="reportes/rpt_cortes.php">
              <div class="row">
                <div class="col-md-3">
          ...
          <div class="box-footer text-right">
            ...
            <a href="javascript:consulta_faltantes()" class="btn btn-danger">Consultar</a>
          </div>
          </form>
        </div>
        <div class="box box-danger">
