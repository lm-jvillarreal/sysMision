<div class="modal fade" id="modal-mOPE009" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<button style="float: right;" type="button" class="btn btn-secondary" data-dismiss="modal">x</button>
				<div>
					<h4 class="modal-title" id="exampleModalLabel">Reportes | Redondeos por Cajero</h4>
				</div>
			</div>
			<div class="modal-body" style="max-height: calc(200vh - 110px); overflow-y: auto;">
				<form method="POST" id="OPE009">
					<div class="row">
						<div class="col-md-3">
						...
						<div class="col-md-3">
							<div class="form-group">
								<label for="sucursal_OPE009">*Sucursal:</label>
								<select name="sucursal_OPE009" id="sucursal_OPE009" class="form-control">
									<option value=""></option>
						...
						<div class="col-md-3">
							<div class="form-group">
								...
								<select name="concepto_OPE009" id="concepto_OPE009" class="form-control">
									<option value=""></option>
								</select>
							</div>
						</div>
					...
					<div class=" text-right">
						<button type="button" class="btn btn-danger" id="btn_OPE009" onclick="generarReporte(this)">Descargar Reporte</button>
					</div>
				</form>
			</div>
		</div>
