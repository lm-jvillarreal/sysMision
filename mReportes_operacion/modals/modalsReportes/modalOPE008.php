<div class="modal fade" id="modal-mOPE008" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<button style="float: right;" type="button" class="btn btn-secondary" data-dismiss="modal">x</button>
				<div>
					<h4 class="modal-title" id="exampleModalLabel">Reportes | Coincidencias por codigo</h4>
				</div>
			</div>
			<div class="modal-body" style="max-height: calc(200vh - 110px); overflow-y: auto;">
				<form method="POST" id="OPE008">
					<div class="row">
						<div class="col-md-3">
						...
						<div class="col-md-3">
							<div class="form-group">
								<label for="sucursal_OPE008">*Sucursal:</label>
								<select name="sucursal_OPE008" id="sucursal_OPE008" class="form-control select">
									<option value=""></option>
						...
						<div class="col-md-3">
							<div class="form-group">
							<label>*Codigo:</label>
								<input type="" name="codigo_OPE008" class="form-control">
							</div>
						</div>
					</div>
					<div class=" text-right">
						<button type="button" class="btn btn-danger" id="btn_OPE008" onclick="generarReporte(this)">Descargar Reporte</button>
					</div>
				</form>
			</div>
		</div>
