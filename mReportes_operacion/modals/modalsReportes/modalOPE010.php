<div class="modal fade" id="modal-mOPE010" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
			...
			<div class="modal-body" style="max-height: calc(200vh - 110px); overflow-y: auto;">
				<form method="POST" id="OPE010">
					...
					<div class=" text-right">
						<button type="button" class="btn btn-danger" id="btn_OPE010" onclick="generarReporte(this)">Descargar Reporte</button>
					</div>
				</form>
			</div>
		</div>
