<div class="modal fade" id="modal-mOPE001" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
			...
			<div class="modal-body" style="max-height: calc(200vh - 110px); overflow-y: auto;">
				<form method="POST" id="OPE001">
					<div class="row">
						...
						<div class="col-md-3">
							<div class="form-group">
								<label for="sucursal_OPE001">*Sucursal:</label>
								<select name="sucursal_OPE001" id="sucursal_OPE001" class="form-control select">
									<option value=""></option>
					...
					<div class=" text-right">
						<button type="button" class="btn btn-danger" id="btn_OPE001" onclick="generarReporte(this)">Descargar Reporte</button>
					</div>
				</form>
			</div>
		</div>
