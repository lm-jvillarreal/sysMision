<?php 
	...
	$qry_traspasos = "SELECT 
					...
					AND (INV_MOVIMIENTOS.MODC_TIPOMOV = 'ETRANS')
					AND (INV_RENGLONES_MOVIMIENTOS.MODC_TIPOMOV = 'ETRANS' )
					--OR INV_RENGLONES_MOVIMIENTOS.MODC_TIPOMOV = 'ENTTRA' 
					--OR INV_RENGLONES_MOVIMIENTOS.MODC_TIPOMOV = 'ETRAAC' 
					--OR INV_RENGLONES_MOVIMIENTOS.MODC_TIPOMOV = 'STRANS' --OR INV_RENGLONES_MOVIMIENTOS.MODC_TIPOMOV= 'ETRANS' --OR --INV_RENGLONES_MOVIMIENTOS.MODC_TIPOMOV= 'ASTRAN' OR --INV_RENGLONES_MOVIMIENTOS.MODC_TIPOMOV = 'ETRAN')
					AND INV_MOVIMIENTOS.ALMN_ALMACEN = '$almacen'
					AND INV_RENGLONES_MOVIMIENTOS.ALMN_ALMACEN = '$almacen'";
		...
		$array_datos = array($row_compras[0], $row_traspasos[0], $row_altas_inv[0],$row_dev_venta[0], $row_forza[0], $row_ventas[0], $row_sal_transf[0], $row_bajas[0], $row_dev_compra[0], $row_existencia[0], $row_inventarios[0], $row_ventas_na[0], $row_sin_afectar[0], $row_astrans[0], $row_aetrans[0]);
