...
$sucursal = $_POST['sucursal_OPE001'];
...
$consulta_principal  = "
	...
	header('Content-Disposition: attachment;filename="Reporte_Existencias_' .$fecha. '.xlsx"');
	//header('Content-Disposition: attachment;filename="rpt_analisis" '.$Msucursal.$fecha.' ".xlsx"');
	//header('Content-Disposition: attachment;filename="rpt_analisis_' .$Msucursal"_"$fecha. '.xlsx"');
