...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="index.php"><i class="fa fa-bars"></i> <span>Por No. Ticket</span></a></li>
        <li><a href="generar_excel.php"><i class="fa fa-bars"></i> <span>Importar Excel</span></a></li>
      </ul>
      <ul class="sidebar-menu" data-widget="tree">
