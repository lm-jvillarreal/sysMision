...
<section class="sidebar">
  ...
  <ul class="sidebar-menu" data-widget="tree">
    ...
    <li class="active"><a href="index.php"><i class="fa fa-plus"></i> <span>Alta Pendiente</span></a></li>
    <li class=""><a href="liberar.php"><i class="fa fa-check"></i> <span>Liberar Pendiente</span></a></li>
  </ul>
  <ul class="sidebar-menu" data-widget="tree">
