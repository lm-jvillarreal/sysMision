...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="index.php"><i class="fa fa-bars"></i> <span>Permisos por usuario</span></a></li>
        <li ><a href="permisos_perfil.php"><i class="fa fa-bars"></i> <span>Permisos por Perfil</span></a></li>
      </ul>
      <ul class="sidebar-menu" data-widget="tree">
