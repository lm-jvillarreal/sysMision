...
$cadena_verifica = "SELECT solo_lectura FROM detalle_usuario WHERE id = '$id_registro'";
...
$cadena_modifica = "UPDATE detalle_usuario SET solo_lectura = '$estado' WHERE id = '$id_registro'";
