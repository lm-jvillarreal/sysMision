...
$cadena_verifica = "SELECT solo_sucursal FROM detalle_usuario WHERE id = '$id_registro'";
...
$cadena_modifica = "UPDATE detalle_usuario SET solo_sucursal = '$estado' WHERE id = '$id_registro'";
