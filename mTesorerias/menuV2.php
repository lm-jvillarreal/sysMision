...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="index.php"><i class="fa fa-money"></i> <span>Efectivos</span></a></li>
        <li class=""><a href="prestamo_morralla.php"><i class="fa fa-university"></i> <span>Prestamo Morralla</span></a></li>
