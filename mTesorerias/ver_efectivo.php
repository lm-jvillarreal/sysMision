    ...
    <section class="content">
        <div class="box box-danger">
          <div class="box-header">
            <h3 class="box-title">Ver Captura de Efectivos</h3>
          </div>
          <div class="box-body">
            <div class="tabbable">
                      ...
                      <br>
                        <div class="row">
                          <div class="col-md-2">
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                ...
                                <input value="<?php echo $row_efectivo[2]?>" type="text" name="efectivo" class="form-control" id="e1" readonly>
                          ...
                          <div class="col-md-2">
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                <div class="input-group-addon">$</div>
                                <input value="<?php echo $row_efectivo[30]?>" type="text" name="efectivo1" class="form-control" id="e2" readonly>
                              </div>
                            </div>
                          </div>
                          <div class="col-md-2">
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                <div class="input-group-addon">$</div>
                                <input value="<?php echo $row_efectivo[31]?>" type="text" name="efectivo2" class="form-control" id="e3" readonly>
                              </div>
                            </div>
                          </div>
                          <div class="col-md-2">
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                <div class="input-group-addon">$</div>
                                <input value="<?php echo $row_efectivo[3]?>" type="text" name="complemento" class="form-control" id="e2" readonly>
                              </div>
                            </div>
                          </div>
                          <div class="col-md-2">
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                <div class="input-group-addon">$</div>
                                <input value="<?php echo $row_efectivo[4]?>" type="text" name="cheques_serfin" class="form-control" id="e3" readonly>
                              </div>
                            </div>
                          </div>
                          <div class="col-md-2">
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                <div class="input-group-addon">$</div>
                                <input value="<?php echo $row_efectivo[5]?>" type="text" name="cheques_locales" class="form-control" id="e4" readonly>
                              </div>
                            </div>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-md-3">
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                <div class="input-group-addon">$</div>
                                <input value="<?php echo $row_efectivo[7]?>" type="text" name="tarjetas_credito" class="form-control" id="e5" readonly>
                              </div>
                            </div>
                          </div>
                        </div>
                        <div class="row">
                          ...
                          <div class="col-md-2">
                            <div class="input-group">
                              <div class="input-group-addon">$</div>
                              <input value="<?php echo $row_efectivo[6]?>" type="text" name="total_efectivos" id="total_efectivos" class="form-control" readonly>
                            </div>
                          </div>
                        </div>
                    </div>
                      ...
                      <div class="row">
                        <div class="col-md-3">
                          <div class="form-group">
                            ...
                            <div class="input-group">
                              <div class="input-group-addon">$</div>
                              <input value="<?php echo $row_efectivo[8]?>" type="text" name="tarjetas_debito" class="form-control" id="t1" readonly>
                            </div>
                          </div>
                        </div>
                        <div class="col-md-3">
                          <div class="form-group">
                            ...
                            <div class="input-group">
                              <div class="input-group-addon">$</div>
                              <input value="<?php echo $row_efectivo[9]?>" type="text" name="tarjetas_prepago" class="form-control" id="t2" readonly>
                            </div>
                          </div>
                        </div>
                        <div class="col-md-3">
                          <div class="form-group">
                            ...
                            <div class="input-group">
                              <div class="input-group-addon">$</div>
                              <input value="<?php echo $row_efectivo[10]?>" type="text" name="tarjetas_accor" class="form-control" id="t3" readonly>
                            </div>
                          </div>
                        </div>
                        <div class="col-md-3">
                          <div class="form-group">
                            ...
                            <div class="input-group">
                              <div class="input-group-addon">$</div>
                              <input value="<?php echo $row_efectivo[11]?>" type="text" name="tarjetas_ecovale" class="form-control" id="t4" readonly>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-md-3">
                          <div class="form-group">
                            ...
                            <div class="input-group">
                              <div class="input-group-addon">$</div>
                              <input value="<?php echo $row_efectivo[12]?>" type="text" name="tarjetas_efectivale" class="form-control" id="t5" readonly>
                            </div>
                          </div>
                        </div>
                        <div class="col-md-3">
                          <div class="form-group">
                            ...
                            <div class="input-group">
                              <div class="input-group-addon">$</div>
                              <input value="<?php echo $row_efectivo[13]?>" type="text" name="tarjetas_sivale" class="form-control" id="t6" readonly>
                            </div>
                          </div>
                        </div>
                        <div class="col-md-3">
                          <div class="form-group">
                            ...
                            <div class="input-group">
                              <div class="input-group-addon">$</div>
                              <input value="<?php echo $row_efectivo[14]?>" type="text" name="tarjeta_pass" class="form-control" id="t7" readonly>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-md-2">
                          <div class="form-group">
                            ...
                            <div class="input-group">
                              <div class="input-group-addon">$</div>
                              <input value="<?php echo $row_efectivo[16]?>" type="text" name="bonos_prestaciones_mex" class="form-control" id="b1" readonly>
                            </div>
                          </div>
                        </div>
                        <div class="col-md-2">
                          <div class="form-group">
                            ...
                            <div class="input-group">
                              <div class="input-group-addon">$</div>
                              <input value="<?php echo $row_efectivo[17]?>" type="text" name="bonos_universales" class="form-control" id="b2" readonly>
                            </div>
                          </div>
                        </div>
                        <div class="col-md-2">
                          <div class="form-group">
                            ...
                            <div class="input-group">
                              <div class="input-group-addon">$</div>
                              <input value="<?php echo $row_efectivo[18]?>" type="text" name="bonos_accor" class="form-control" id="b3" readonly>
                            </div>
                          </div>
                        </div>
                        <div class="col-md-2">
                          <div class="form-group">
                            ...
                            <div class="input-group">
                              <div class="input-group-addon">$</div>
                              <input value="<?php echo $row_efectivo[19]?>" type="text" name="bonos_efectivale" class="form-control" id="b4" readonly>
                            </div>
                          </div>
                        </div>
                        <div class="col-md-2">
                          <div class="form-group">
                            ...
                            <div class="input-group">
                              <div class="input-group-addon">$</div>
                              <input value="<?php echo $row_efectivo[20]?>" type="text" name="bonos_mision_especial" class="form-control" id="b5" readonly>
                            </div>
                          </div>
                        </div>
                        <div class="col-md-2">
                          <div class="form-group">
                            ...
                            <div class="input-group">
                              <div class="input-group-addon">$</div>
                              <input value="<?php echo $row_efectivo[21]?>" type="text" name="bonos_creditos" class="form-control" id="b6" readonly>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-md-2">
                          <div class="form-group">
                            ...
                            <div class="input-group">
                              <div class="input-group-addon">$</div>
                              <input type="text" name="tengo_despensa" class="form-control" id="b7" value="<?php echo $row_efectivo[32]?>">
                            </div>
                          </div>
                        </div>
                      </div>
              ...
              <div class="box-footer text-right">
                <a href="reporte_excel_efectivos.php?folio=<?php echo $folio;?>" class="btn btn-warning">Generar Reporte Excel</a>
              </div>
          </div>
        </div>
        <div class="box box-danger">
