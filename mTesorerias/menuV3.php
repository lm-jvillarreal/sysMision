...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class=""><a href="index.php"><i class="fa fa-money"></i> <span>Efectivos</span></a></li>
        <li class="active"><a href="prestamo_morralla.php"><i class="fa fa-university"></i> <span>Prestamo Morralla</span></a></li>
        <li class=""><a href="faltantes.php"><i class="fa fa-bitcoin"></i> <span>Faltante Morralla</span></a></li>
        <li><a href="firmas.php"><i class="fa fa-google-wallet"></i> <span>Firmas</span></a></li>
        <li><a href="grafica.php"><i class="fa fa-bar-chart"></i> <span>Grafica</span></a></li>
      </ul>
      <ul class="sidebar-menu" data-widget="tree">
