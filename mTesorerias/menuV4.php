...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="prestamo_morralla.php"><i class="fa fa-university"></i> <span>Prestamo Morralla</span></a></li>
        <li class=""><a href="faltantes.php"><i class="fa fa-bitcoin"></i> <span>Faltante Morralla</span></a></li>
        <li class="active"><a href="firmas.php"><i class="fa fa-google-wallet"></i> <span>Firmas</span></a></li>
