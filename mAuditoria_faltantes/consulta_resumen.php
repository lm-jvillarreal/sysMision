...
//Consulta de totales
$cadena_total = "SELECT COUNT(*) FROM faltantes_pasven WHERE  DATE(fecha_captura) BETWEEN DATE_SUB(NOW(),INTERVAL 7 DAY) AND DATE(NOW())".$filtro_sucursal;
...
$cadena_gerente = "SELECT COUNT(*) FROM faltantes_pasven WHERE  DATE(fecha_captura) BETWEEN DATE_SUB(NOW(),INTERVAL 7 DAY) AND DATE(NOW()) AND estatus = '2'".$filtro_sucursal;
...
$cadena_enviados = "SELECT COUNT(*) FROM faltantes_pasven WHERE  DATE(fecha_captura) BETWEEN DATE_SUB(NOW(),INTERVAL 7 DAY) AND DATE(NOW()) AND (estatus = '3' or estatus = '4')".$filtro_sucursal;
...
//Estatus 4
$cadena_resCompras = "SELECT COUNT(*) FROM faltantes_pasven WHERE  DATE(fecha_captura) BETWEEN DATE_SUB(NOW(),INTERVAL 7 DAY) AND DATE(NOW()) AND estatus = '4'".$filtro_sucursal;
...
//Estatus 5
$cadena_entrada = "SELECT COUNT(*) FROM faltantes_pasven WHERE  DATE(fecha_captura) BETWEEN DATE_SUB(NOW(),INTERVAL 7 DAY) AND DATE(NOW()) AND (estatus = '5' or estatus = '7' or estatus = '8')".$filtro_sucursal;
...
//Estatus 7 y 8
$cadena_piso = "SELECT COUNT(*) FROM faltantes_pasven WHERE  DATE(fecha_captura) BETWEEN DATE_SUB(NOW(),INTERVAL 7 DAY) AND DATE(NOW()) AND (estatus = '7' or estatus = '8')".$filtro_sucursal;
...
//estatus 8
$cadena_audita = "SELECT COUNT(*) FROM faltantes_pasven WHERE  DATE(fecha_captura) BETWEEN DATE_SUB(NOW(),INTERVAL 7 DAY) AND DATE(NOW()) AND (estatus = '9')".$filtro_sucursal;
...
$cadena_auditaBien = "SELECT COUNT(*) FROM faltantes_pasven WHERE  DATE(fecha_captura) BETWEEN DATE_SUB(NOW(),INTERVAL 7 DAY) AND DATE(NOW()) AND estatus = '8'".$filtro_sucursal;
...
$cadena_auditaMal = "SELECT COUNT(*) FROM faltantes_pasven WHERE  DATE(fecha_captura) BETWEEN DATE_SUB(NOW(),INTERVAL 7 DAY) AND DATE(NOW()) AND estatus = '9'".$filtro_sucursal;
...
//estatus 8
$cadena_ajuste = "SELECT COUNT(*) FROM faltantes_pasven WHERE  DATE(fecha_captura) BETWEEN DATE_SUB(NOW(),INTERVAL 7 DAY) AND DATE(NOW()) AND estatus = '10'".$filtro_sucursal;
