...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="index.php"><i class="fa fa-bars"></i> <span>Lista de códigos</span></a></li>
        <li><a href="bitacora_auditorias.php"><i class="fa fa-bars"></i> <span>Bitácora de audiorías</span></a></li>
        <li class="active"><a href="resumen_faltantes.php"><i class="fa fa-bars"></i> <span>Resumen de Faltantes</span></a></li>
        <li><a href="resumen_fechas.php"><i class="fa fa-bars"></i> <span>Resumen por fechas</span></a></li>
      </ul>
      <ul class="sidebar-menu" data-widget="tree">
