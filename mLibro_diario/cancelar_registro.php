...
$cadena_update = "UPDATE orden_compra SET status = NULL, activo = '1', completo = '0', hora_inicio = NULL, hora_final = NULL, fecha_inicio = NULL, fecha_final = NULL, usuario_inicio = NULL, usuario_final = NULL, comentarios = NULL WHERE id = '$id_orden'";
