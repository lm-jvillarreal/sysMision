    ...
    <section class="content">
        <div class="box box-danger" <?php echo $solo_lectura?>>
          <div class="box-header">
            <h3 class="box-title">Movimientos Mant. | Entrada</h3>
          </div>
          <div class="box-body">
              ...
              <div class="row">
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" name="orden" id="orden" class="form-control" placeholder="Orden de Compra">
                  </div>
                </div>
                <div class="col-md-3">
                  <div class="form-group">
              ...
              <div class="row">
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" name="descripcion" id="descripcion" class="form-control" placeholder="Descripcion" readonly>
                  </div>
                </div>
                <div class="col-md-3">
                  <div class="form-group">
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    <label>*Ult.Costo:</label>
                    <div class="input-group">
                      <div class="input-group-addon">$</div>
                      <input type="text" name="u_costo" id="u_costo" class="form-control" placeholder="Utl. Costo">
                    </div>
                  </div>
                </div>
                <div class="col-md-3">
        ...
        <div class="box box-danger" id="tabla_principal">
          <div class="box-header">
            <h3 class="box-title">Entradas | Lista</h3>
          </div>
          <div class="box-body">
            <div class="row">
        ...
        <div class="box box-danger" id="tabla2" style="display: none;">
          <div class="box-header">
            <h3 class="box-title">Entradas | Detalle</h3>
          </div>
          <div class="box-body">
            <div class="row">
              <div class="col-md-12">
