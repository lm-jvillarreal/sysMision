...
<section class="sidebar">
  ...
  <ul class="sidebar-menu" data-widget="tree">
    ...
    <li class="active"><a href="index.php"><i class="fa fa-arrow-circle-left"></i> <span>Entradas</span></a></li>
    <li class=""><a href="salidas.php"><i class="fa fa-arrow-circle-right"></i> <span>Salidas</span></a></li>
  </ul>
  <ul class="sidebar-menu" data-widget="tree">
