            ...
            <div class="row">
              ...
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  <select name="incidencia" id="incidencia" class="form-control select2">
                  </select>
                </div>
              </div>
		          <div class="col-md-3">
...
<script>
  ...
  function cargar_tabla(){
      ...
      $('#lista_incidencias').DataTable( {
          ...
          "ajax": {
              "type": "POST",
              "url": "http://200.1.1.197/SMPruebas/mRegistro_incidencias/tabla_registros.php",
              "dataSrc": "",
          },
          "columns": [
              { "data": "id" },
...
$(function () {
  ...
  function editar(id){
    var url = 'http://200.1.1.197/SMPruebas/mRegistro_incidencias/consulta_datos_editar_incidencias.php';
    $.ajax({
      url: url,
      type: "POST",
      dateType: "html",
