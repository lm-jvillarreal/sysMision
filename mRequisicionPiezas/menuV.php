...
<section class="sidebar">
  ...
  <ul class="sidebar-menu" data-widget="tree">
    ...
    <li class="active"><a href="index.php"><i class="fa fa-plus"></i> <span>Requisición de Piezas</span></a></li>
    <li class="active"><a href="liberar.php"><i class="fa fa-list-alt"></i> <span>Liberar Piezas</span></a></li>
  </ul>
  <ul class="sidebar-menu" data-widget="tree">
