...
?>
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class=""><a href="index.php"><i class="fa fa-dollar"></i> <span>Registro de Gastos</span></a></li>
      ...
      <li class="active"><a href="grafica.php"><i class="fa fa-bar-chart"></i><span>Grafica por RFC</span></a></li>
    </ul>
    <ul class="sidebar-menu" data-widget="tree">
