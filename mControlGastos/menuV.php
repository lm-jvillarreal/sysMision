...
?>
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class="active"><a href="index.php"><i class="fa fa-database"></i> <span>Cargar Meta-Data</span></a></li>
      <li><a href='#' data-id = '' data-toggle = 'modal' data-target = '#modal-default1' target='blank'><i class="fa fa-registered"></i><span>Rublo</span></a></li>
      </span></a></li>
      <li><a href='#' data-id = '' data-toggle = 'modal' data-target = '#modal-default' target='blank'><i class="fa fa-road"></i><span>Rancho</span></a></li>
      <li><a href="gasto.php"><i class="fa fa-usd"></i><span>Registrar Gasto</span></a></li>
      <li><a href="grafica.php"><i class="fa fa-bar-chart"></i><span>Grafica por RFC</span></a></li>
    </ul>
    <ul class="sidebar-menu" data-widget="tree">
