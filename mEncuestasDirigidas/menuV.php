...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="index.php"><i class="fa fa-plus"></i><span>Registro de Encuestas</span></a></li>
        <li class="active"><a href="listas.php"><i class="fa fa-list-alt"></i><span>Asignacion de Encuestas</span></a></li>
        <!-- <li class="active"><a href="resultados.php"><i class="fa fa-list-alt"></i><span>Resultados</span></a></li> -->
      </ul>
      <ul class="sidebar-menu" data-widget="tree">
