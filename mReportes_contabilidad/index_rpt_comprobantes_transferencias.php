      ...
      <section class="content">
        <div class="box box-danger">
          <div class="box-header">
            <h3 class="box-title">Reportes |Comprobantes-Transferencias </h3>
          </div>
          <div class="box-body">
            <form method="POST" id="form_datoss" action="reportes/rpt_comprobantes_transferencias.php">
              <div class="row">
                <div class="col-md-3">
        ...
        <div class="box box-danger">
          <div class="box-header">
            <h3 class="box-title">Reporte de Transferencias | Listado</h3>
          </div>
          <div class="box-body">
            <div class="row">
              <div class="col-md-12">
