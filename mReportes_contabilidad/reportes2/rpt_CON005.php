...
$fecha = date('Y-m-d');
$fecha_inicio = $_POST['fecha_inicial_CON005'];
$fecha_final = $_POST['fecha_final_CON005'];
...
// 	//error_reporting(E_ALL);
	...
	header('Content-Disposition: attachment;filename="Polizas_transferencias_'.$fecha.'.xlsx"');
