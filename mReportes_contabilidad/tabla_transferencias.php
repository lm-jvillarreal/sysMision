...
$cadenaCheques = "SELECT
                      ban_solpag.soli_numch,
                      RTRIM( ctb_polizas_tranferencias.ptrc_benef ),
                      ctb_polizas_tranferencias.ptrn_monto,
                      TO_CHAR ( ctb_polizas_tranferencias.PTRD_FECHA, 'YYYY/MM/DD' ) 
                    FROM
                      ban_solpag
                      INNER JOIN CTB_POLIZAS_TRANFERENCIAS ON ban_solpag.solc_indice = ctb_polizas_tranferencias.polc_indice 
                    WHERE
                      SOLN_ESTATUS != '5' 
