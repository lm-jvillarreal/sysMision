...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="index.php"><i class="fa fa-bars"></i> <span>Registro de Pedidos</span></a></li>
        <li class="active"><a href="historial_pedidos.php"><i class="fa fa-bars"></i> <span>Resumen de pedidos</span></a></li>
      </ul>
      <ul class="sidebar-menu" data-widget="tree">
