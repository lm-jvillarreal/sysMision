...
$cadena_verifica = "SELECT activo FROM catalogo_incidencias WHERE id = '$id_registro'";
...
$cadena_modifica = "UPDATE catalogo_incidencias SET activo = '$estado' WHERE id = '$id_registro'";
