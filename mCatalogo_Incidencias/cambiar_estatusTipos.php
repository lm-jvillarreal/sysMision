...
$cadena_verifica = "SELECT activo FROM tipos_incidencias WHERE id = '$id_registro'";
...
$cadena_modifica = "UPDATE tipos_incidencias SET activo = '$estado' WHERE id = '$id_registro'";
