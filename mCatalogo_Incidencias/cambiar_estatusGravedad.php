...
$cadena_verifica = "SELECT activo FROM gravedad_incidencias WHERE id = '$id_registro'";
...
$cadena_modifica = "UPDATE gravedad_incidencias SET activo = '$estado' WHERE id = '$id_registro'";
