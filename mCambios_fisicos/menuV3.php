...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="cambiosFisicos_pendientes.php"><i class="fa fa-bars"></i> <span>Cambios Pendientes</span></a></li>
        <li class="active"><a href="cambiosFisicos_liberados.php"><i class="fa fa-bars"></i> <span>Cambios Liberadas</span></a></li>
      </ul>
      <ul class="sidebar-menu" data-widget="tree">
