...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="lista_personas.php"><i class="fa fa-bars"></i> <span>Lista de Personal</span></a></li>
        <li><a href="cambia_sucursal.php"><i class="fa fa-bars"></i> <span>Cambiar de Sucursal</span></a></li>
      </ul>
      <ul class="sidebar-menu" data-widget="tree">
