...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="index.php"><i class="fa fa-bars"></i> <span>Lista de Órdenes</span></a></li>
        <li><a href="calendario.php"><i class="fa fa-bars"></i> <span>Calendario</span></a></li>
      </ul>
      <ul class="sidebar-menu" data-widget="tree">
