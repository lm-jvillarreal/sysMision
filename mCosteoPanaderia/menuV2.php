...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="index.php"><i class="fa fa-bars"></i> <span>Materias Primas</span></a></li>
        <li  class="active"><a href="subrecetas.php"><i class="fa fa-bars"></i> <span>Sub-recetas</span></a></li>
        <li><a href="cedula_costos.php"><i class="fa fa-bars"></i> <span>Cédula de costos</span></a></li>
        <li><a href="resumen_rentabilidad.php"><i class="fa fa-bars"></i> <span>Precios IVA</span></a></li>
      </ul>
      <ul class="sidebar-menu" data-widget="tree">
