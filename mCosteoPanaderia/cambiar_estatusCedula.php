...
$cadena_verifica = "SELECT ACTIVO FROM panaderia_recetasventarenglones WHERE ID = '$ide'";
...
$cadena_modifica = "UPDATE panaderia_recetasventarenglones SET ACTIVO = '$estado' WHERE ID = '$ide'";
