...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class=""><a href="index.php"><i class="fa fa-bars"></i> <span>Registro de errores</span></a></li>
        <li><a href='#' data-id = '' data-toggle = 'modal' data-target = '#modal-default' target='blank'><i class="fa fa-commenting"></i><span>Registro Comentario</span></a></li>
