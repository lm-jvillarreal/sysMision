...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="index.php"><i class="fa fa-bars"></i> <span>Registro de errores</span></a></li>
        ...
        <li class=""><a href="grafica.php"><i class="fa fa-bar-chart"></i> <span>Grafica</span></a></li>
      </ul>
      <ul class="sidebar-menu" data-widget="tree">
