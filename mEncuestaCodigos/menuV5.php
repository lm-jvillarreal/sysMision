...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class=""><a href="aplicar_examen.php"><i class="fa fa-clipboard"></i> <span>Aplicar Examen</span></a></li>
        <li class=""><a href="res_empleado.php"><i class="fa fa-users"></i> <span>Resultados por Empleado</span></a></li>
        <li class="active"><a href="desac_examen.php"><i class="fa fa-ban"></i> <span>Desactivar Exámenes</span></a></li>
      </ul>
      <ul class="sidebar-menu" data-widget="tree">
