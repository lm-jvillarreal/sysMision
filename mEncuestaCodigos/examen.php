        ...
        <form method="POST" id="form_datos">
          ...
          <div class="box-body">
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <label for="nombre">*Catálogo:</label>
                  <select name="catalogo" id="catalogo" class="form-control" onchange="habilitar()"></select>
                </div>
              </div>
            </div>
          </div>
  ...
  function cargar_tabla(){
    ...
    var table = $('#lista_codigos').DataTable( {
      ...
      "ajax": {
          ...
          "dataSrc": "",
          "data":{'id_catalogo':id_catalogo,'id_examen':id_examen},
      },
      "columns": [
        { "data": "#","width":"3%"},
        { "data": "Codigo","width":"5%"},
  ...
  function editar_examen(id){
    $.ajax({
      ...
      success: function(respuesta)
      {
        ...
        $('#tipo').val(array[1]).trigger('change.select2');
        $('#contenedor_tabla2').show();
      }
    });
  }
