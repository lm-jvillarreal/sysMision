...
<section class="sidebar">
  ...
  <ul class="sidebar-menu" data-widget="tree">
    ...
    <li class="active"><a href="listamantenimiento.php"><i class="fa fa-list-ul"></i> <span>Lista de Mtto. de Cajas</span></a></li>
    <li class=""><a href="bitacora_reportes.php"><i class="fa fa-list-ul"></i> <span>Bitacora de Reportes.</span></a></li>
  </ul>
  <ul class="sidebar-menu" data-widget="tree">
