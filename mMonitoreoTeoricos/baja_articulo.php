...
$cadenaCod = "SELECT artc_articulo FROM monitoreo_teoricos WHERE id = '$cod'";
...
$descripcion = "***DESCATALOGADO*** ".$row_desc[0];
//Fecha y hora actual
date_default_timezone_set('America/Monterrey');
$fecha=date("Y-m-d");
$fecha_dos = date("d/M/y");
$hora=date ("h:i:s");
$cadenaDes = "UPDATE COM_ARTICULOS SET ARTN_ESTATUS = 2, ARTD_BAJA = '$fecha_dos', ARTC_DESCRIPCION = '$descripcion',ARTC_DESCRIPCION_LARGA = '$descripcion' WHERE ARTC_ARTICULO = '$codigo'";
$stid = oci_parse($conexion_central, $cadenaDes);
//echo $cadenaDes;
oci_execute($stid);
