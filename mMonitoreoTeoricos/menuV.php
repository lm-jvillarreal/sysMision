...
<section class="sidebar">
  ...
  <ul class="sidebar-menu" data-widget="tree">
    ...
    <li class="active"><a href="index.php"><i class="fa fa-bars"></i> <span>Importar Folio</span></a></li>
    <li><a href="registro_manual.php"><i class="fa fa-bars"></i> <span>Registro manual</span></a></li>
  </ul>
  <ul class="sidebar-menu" data-widget="tree">
