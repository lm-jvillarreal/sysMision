...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="index.php"><i class="fa fa-bars"></i> <span>Registrar cargo</span></a></li>
        <li><a href="cargos_vigentes.php"><i class="fa fa-bars"></i> <span>Cargos vigentes</span></a></li>
      </ul>
      <ul class="sidebar-menu" data-widget="tree">
