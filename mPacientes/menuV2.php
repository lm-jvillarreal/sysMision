...
<section class="sidebar">
  ...
  <ul class="sidebar-menu" data-widget="tree">
    ...
    <li><a href="index.php"><i class="fa fa-bars"></i> <span>Pacientes</span></a></li>
    ...
    <li class="active"><a href="lista_recetas.php"><i class="fa fa-bars"></i> <span>Complemento de recetas</span></a></li>
  </ul>
  <ul class="sidebar-menu" data-widget="tree">
