      ...
      <form method="POST" id="form-catalogo" enctype="multipart/form-data">
        <div class="box box-danger">
          <div class="box-header">
            <h3 class="box-title">Control de Plantillas | Importador</h3>
          </div>
          <div class="box-body">
            <div class="row">
              <div class="col-md-4">
...
<script>
  ...
  $('#form-catalogo').submit(function ( e ) {
    ...
    $.ajax({
        url: 'importar_plantilla.php', //URL destino
        data: data,
        ...
        success: function (resultado) {
            if(resultado=="ok"){
              swal("Satisfactorio!!", "La importación de la plantilla se realizó satisfactoriamente","success");
