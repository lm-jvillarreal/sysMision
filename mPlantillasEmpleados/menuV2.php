...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="header">Control de Artículos</li>
        <li><a href="index.php"><i class="fa fa-bars"></i> <span>Importador de Plantillas</span></a></li>
        <li class="active"><a href="plantilla.php"><i class="fa fa-bars"></i> <span>Plantilla</span></a></li>
      </ul>
      <ul class="sidebar-menu" data-widget="tree">
