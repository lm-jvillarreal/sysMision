<div class="modal fade" id="modal_ofertas" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
							...
							<div class="panel panel-primary">
						        ...
						        <div class="panel-body">
									<div class="form-group">
										...
										<input readonly type="text" class="form-control" id="o_do">
										<label for="codigo">Arboledas</label>
										<input type="text" id="o_arb" name="codigo" class="form-control" readonly>
										<br>
										<label for="descripcion">Villegas</label>
										<input type="text" readonly id="o_vil" class="form-control">
										<br>
