...
<section class="sidebar">
  ...
  <ul class="sidebar-menu" data-widget="tree">
    ...
    <li class="active"><a href="index.php"><i class="fa fa-calendar"></i> <span>Calendario</span></a></li>
    <li class=""><a href="resumen.php"><i class="fa fa-calendar-check-o"></i> <span>Resumen Calendario</span></a></li>
    <li class=''><a href='../mVacaciones/index.php'><i class='fa fa-bandcamp'></i> <span>Vacaciones</span></a></li> <li class=''><a href='#' onclick='limpiar_agenda()'><i class='fa fa-wrench'></i> <span>Limpiar Agenda</span></a></li>
  </ul>
  <ul class="sidebar-menu" data-widget="tree">
