...
<section class="sidebar">
  ...
  <ul class="sidebar-menu" data-widget="tree">
    ...
    <li class=""><a href="index.php"><i class="fa fa-calendar"></i> <span>Calendario</span></a></li>
    <li class="active"><a href="resumen.php"><i class="fa fa-calendar-check-o"></i> <span>Resumen Calendario</span></a></li>
