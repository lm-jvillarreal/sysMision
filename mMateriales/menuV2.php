...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class=""><a href="index.php"><i class="fa fa-angle-up"></i> <span>Alta Materiales</span></a></li>
        <li class="active"><a href="material.php"><i class="fa fa fa-bars"></i> <span>Usar Material</span></a></li>
      </ul>
      <ul class="sidebar-menu" data-widget="tree">
