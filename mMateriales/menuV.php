...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="index.php"><i class="fa fa-angle-up"></i> <span>Alta Materiales</span></a></li>
        <li><a href='#' data-id = '' data-toggle = 'modal' data-target = '#modal-default1' target='blank'><i class="fa fa fa-hand-paper-o"></i><span>Usar Material</span></a></li>
        <li><a href='#' data-id = '' data-toggle = 'modal' data-target = '#modal-default' target='blank'><i class="fa fa-list-alt"></i><span>Materiales Pedidos</span></a></li>
      </ul>
      <ul class="sidebar-menu" data-widget="tree">
