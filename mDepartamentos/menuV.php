...
<section class="sidebar">
  ...
  <ul class="sidebar-menu" data-widget="tree">
    ...
    <li class="active"><a href="index.php"><i class="fa fa-building"></i> <span>Departamentos</span></a></li>
    <li class=""><a href="agrupaciones.php"><i class="fa fa-bullhorn"></i> <span>Agrupaciones</span></a></li>
  </ul>
  </ul>
  <ul class="sidebar-menu" data-widget="tree">
