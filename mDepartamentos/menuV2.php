...
<section class="sidebar">
  ...
  <ul class="sidebar-menu" data-widget="tree">
    ...
    <li class=""><a href="index.php"><i class="fa fa-building"></i> <span>Departamentos</span></a></li>
    <li class="active"><a href="agrupaciones.php"><i class="fa fa-bullhorn"></i> <span>Agrupaciones</span></a></li>
  </ul>
  <ul class="sidebar-menu" data-widget="tree">
