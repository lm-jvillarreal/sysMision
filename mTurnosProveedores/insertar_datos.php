<?php
  ...
  $insertar_datos = mysqli_query($conexion, "INSERT INTO turnos (prefijo, consecutivo, fecha, hora, activo, id_usuario, id_sede) VALUES ('$prefijo','$consecutivo','$fecha','$hora', '0', '$id_usuario', '$id_sede' )");
