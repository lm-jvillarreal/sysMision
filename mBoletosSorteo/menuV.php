...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="index.php"><i class="fa fa-bars"></i> <span>Registro de Boletos</span></a></li>
        <li class="active"><a href="index_.php"><i class="fa fa-bars"></i> <span>Escaneo de Boletos</span></a></li>
      </ul>
      <ul class="sidebar-menu" data-widget="tree">
