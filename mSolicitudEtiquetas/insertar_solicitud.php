...
$cadena_insertar = "INSERT INTO solicitud_etiquetas (nombre, formato, sucursal, estatus, tipo, fecha_solicitud, fecha, hora, activo, usuario_solicita)VALUES('$nombre', '', '$id_sede', '0', '1', '$fecha_solicitud', '$fecha', '$hora', '0', '$id_usuario')";
