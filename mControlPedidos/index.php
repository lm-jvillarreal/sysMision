      ...
      <section class="content">
        <div class="box box-danger">
          <div class="box-header">
            <h3 class="box-title">Control de Pedidos | Listado de pedidos</h3>
          </div>
          <div class="box-body">
            <div class="row">
              <div class="col-md-12">
  ...
  <script>
    ...
    $("#btn_finalizar").click(function() {
      ...
      $.ajax({
        ...
        success: function(respuesta) {
          if(respuesta=="nulo"){
            swal("Cantidades Nulas", "No puedes finalizar un pedido con artículos sin cantidad asignada.", "error");
          }else{
