...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="index.php"><i class="fa fa-bars"></i> <span>Surtir pedido</span></a></li>
        <li class="active"><a href="bitacora_pedidos.php"><i class="fa fa-bars"></i> <span>Historial pedidos</span></a></li>
      </ul>
      <ul class="sidebar-menu" data-widget="tree">
