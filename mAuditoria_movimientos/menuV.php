...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="index.php"><i class="fa fa-bars"></i> <span>Seleccionar Filtros</span></a></li>
        <li class="active"><a href="#"><i class="fa fa-bars"></i> <span>Detalle de movimientos</span></a></li>
      </ul>
      <ul class="sidebar-menu" data-widget="tree">
