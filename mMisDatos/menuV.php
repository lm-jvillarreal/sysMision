...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="index.php"><i class="fa fa-bars"></i> <span>Modificar Mis Datos</span></a></li>
        <li><a href="cambiar_fotografia.php"><i class="fa fa-bars"></i> <span>Cambiar Fotografía</span></a></li>
