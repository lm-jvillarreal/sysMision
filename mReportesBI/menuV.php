...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="header">Reportes disponibles</li>
        <li class="active"><a href="index.php"><i class="fa fa-bars"></i> <span>Ventas por tienda</span></a></li>
        <li><a href="index_familia.php"><i class="fa fa-bars"></i> <span>Ventas por familia</span></a></li>
        <li><a href="index_depto.php"><i class="fa fa-bars"></i> <span>Ventas por departamento</span></a></li>
        <li><a href="index_prov.php"><i class="fa fa-bars"></i> <span>Ventas por proveedor</span></a></li>
      </ul>
      <ul class="sidebar-menu" data-widget="tree">
