...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="index.php"><i class="fa fa-bars"></i> <span>Ventas por tienda</span></a></li>
        ...
        <li class="active"><a href="index_prov.php"><i class="fa fa-bars"></i> <span>Ventas por proveedor</span></a></li>
      </ul>
      <ul class="sidebar-menu" data-widget="tree">
