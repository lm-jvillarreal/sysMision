<div class="modal fade" id="modal-mADM003" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<button style="float: right;" type="button" class="btn btn-secondary" data-dismiss="modal">x</button>
				<div>
					<h4 class="modal-title" id="exampleModalLabel">Reporte | Reporte de ventas por familia</h4>
				</div>
			</div>
			<div class="modal-body" style="max-height: calc(200vh - 110px); overflow-y: auto;">
				<form method="POST" id="ADM003">
					<div class="row">
						<div class="col-md-3">
						...
						<div class="col-md-3">
							<div class="form-group">
								<label for="sucursal_ADM003">*Sucursal:</label>
								<select name="sucursal_ADM003" id="sucursal_ADM003" class="form-control select">
									<option value=""></option>
					...
					<div class=" text-right">
						<button type="button" class="btn btn-danger" id="btn_ADM003" onclick="generarReporte(this)">Descargar Reporte</button>
					</div>
				</form>
			</div>
		</div>
