<div class="modal fade" id="modal-mADM005" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<button style="float: right;" type="button" class="btn btn-secondary" data-dismiss="modal">x</button>
				<div>
					<h4 class="modal-title" id="exampleModalLabel">Reporte | Consolidado de ventas por proveedor</h4>
				</div>
			</div>
			<div class="modal-body" style="max-height: calc(200vh - 110px); overflow-y: auto;">
				<form method="POST" id="ADM005">
					<div class="row">
						<div class="col-md-3">
						...
						<div class="col-md-3">
							<div class="form-group">
								<label for="sucursal_ADM005">*Sucursal:</label>
								<select name="sucursal_ADM005" id="sucursal_ADM005" class="form-control select">
									<option value=""></option>
					...
					<div class=" text-right">
						<button type="button" class="btn btn-danger" id="btn_ADM005" onclick="generarReporte(this)">Descargar Reporte</button>
					</div>
				</form>
			</div>
		</div>
