			...
			<section class="content">
				<div class="box box-danger">
					<div class="box-header">
						<h3 class="box-title">Resumen de Cartas Faltantes</h3>
					</div>
					<div class="box-body">
						<div class="row">
							<div class="col-md-12">
								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<select name="proveedor" id="proveedor" class="form-control" onchange="cargar()">
											<option value=""></option>
										</select>
									</div>
								</div>
								...
								<div class="col-md-4 col-sm-6 col-xs-12">
									<div class="info-box bg-aqua">
										...
										<div class="info-box-content">
											<span class="info-box-text">Cartas Faltantes Registradas</span>
						      ...
						      <table id='lista_proveedores' class='table table-striped table-bordered' cellspacing='0' width='100%'>
						        <thead>
						          <tr>
						            <th width="5%">#</th>
						            <th >Proveedor</th>
						            <th width="12%">Cartas Faltantes</th>
