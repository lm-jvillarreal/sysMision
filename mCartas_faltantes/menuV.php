...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="index.php"><i class="fa fa-bars"></i> <span>Cartas Faltantes</span></a></li>
        <li class=""><a href="resumen.php"><i class="fa fa-bar-chart"></i> <span>Resumen</span></a></li>
      </ul>
      <ul class="sidebar-menu" data-widget="tree">
