...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="index.php"><i class="fa fa-bars"></i> <span>Generar Vale</span></a></li>
        <li class="active"><a href="reimprimir_vale.php"><i class="fa fa-bars"></i> <span>Reimprimir Vale</span></a></li>
      </ul>
      <ul class="sidebar-menu" data-widget="tree">
