...
$cadenaDesglose="SELECT ID, ID_ARTICULO, CANTIDAD_RECETA, SUBRECETA, ACTIVO FROM pasteleria_subrecetasrenglones WHERE ID_SUBRECETA='$id_receta' AND ACTIVO='1'";
