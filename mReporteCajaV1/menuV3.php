...
<section class="sidebar">
  ...
  <ul class="sidebar-menu" data-widget="tree">
    ...
    <li class=""><a href="lista_reportes.php"><i class="fa fa-list"></i> <span>Lista de Reportes</span></a></li>
    <li class="active"><a href="mantenimiento.php"><i class="fa fa-wrench"></i> <span>Mantenimiento de Caja</span></a></li>
  </ul>
  <ul class="sidebar-menu" data-widget="tree">
