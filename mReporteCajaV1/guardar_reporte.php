<?php
	...
	if ($id_registro == 0){
		...
		if($existe == 0){
			$consulta = mysqli_query($conexion,"INSERT INTO reportes_cajas (id_caja, id_equipo, falla, status, activo, fecha, hora, id_usuario) VALUES ('$id_caja','$id_equipo','$descripcion','1','1','$fecha','$hora','$id_usuario')");
			echo "ok";
		}else{
			echo "duplicado";
		}
