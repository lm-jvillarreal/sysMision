    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="index.php"><i class="fa fa-pencil"></i> <span>Alta Pedido</span></a></li>
        <li class="active"><a href="tabla_editar.php"><i class="fa fa-edit"></i> <span>Editar Pedido</span></a></li>
      </ul>
      <ul class="sidebar-menu" data-widget="tree">
