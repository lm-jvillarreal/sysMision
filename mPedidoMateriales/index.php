                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                        <div class="form-group">
                          <label for="folio">*Folio</label>
                            <input  name="folio" id="folio" class="form-control" readonly>
                        </div>
                    </div> 
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                        <div class="form-group">
                          <label for="bodega">*Bodega</label>
                          <input class="form-control " style="width: 100%;" name="bodega" id="bodega" readonly>
                        </div>
                    </div>
                </div>
                <div class="row">
                            ...
                            while($row=mysqli_fetch_array($consulta_tabla))
                                {?>
                                    <tr>
                                        ...
                                        <!-- <td>
                                            <center><input type="text" class="form-control hidden" style="border:none" id="codigo<?php echo $n;?>" name="codigo[]" readonly value="<?php echo "$row[3]"; ?>"></center>
                                        </td> -->
                                        <td>
                                            <center><input type="text" class="form-control" style="border:none" id="nombre<?php echo $n;?>" name="nombre[]" disabled value="<?php echo "$row[4]"; ?>"></center>
                                            <input type="text" class="form-control hidden" style="border:none" id="codigo<?php echo $n;?>" name="codigo[]" readonly value="<?php echo "$row[3]"; ?>">
                                        </td>
                                        <td>
                                            <center><input type="text" class="form-control" style="border:none" id="descripcion<?php echo $n;?>" name="descripcion[]" disabled value="<?php echo "$row[5]"; ?>"></center>       
                                        </td>
                                        <td>
                                            <center><input type="text" class="form-control" style="border:none" id="existencia<?php echo $n;?>" name="existencia[]" disabled value="<?php echo "$row[6]"; ?>"></center>
                                        </td>
                                        <td>
                                            <center><input class="form-control" type="number" id="pedido<?php echo $n;?>" name="pedido[]" min="0" max="999" value="0" onchange="javascript:validar('<?php echo $n;?>',$('#codigo'+<? echo $n ?>).val(),$('#existencia'+<? echo $n ?>).val(),this.value,'<?php echo $row[1];?>');"></center>
                                        </td>
                                    </tr>
                                 <?php 
                                 $n++;
