...
?>
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li><a href="index.php"><i class="fa fa-bars"></i> <span>Alta de muebles</span></a></li>
      <li><a href="zonificacion.php"><i class="fa fa-bars"></i> <span>Zonificación</span></a></li>
      <li class="active"><a href="planograma.php"><i class="fa fa-bars"></i> <span>Planograma</span></a></li>
    </ul>
    <ul class="sidebar-menu" data-widget="tree">
