...
while ($row_caducidad = mysqli_fetch_array($consulta_caducidad)) {
    ...
    $traspaso = "<center><a href='#' data-id = '$row_caducidad[7]' data-suc = '$row_caducidad[6]' data-max = '$row_caducidad[4]' data-toggle = 'modal' data-target = '#modal-traspaso' class='btn btn-danger' target='blank'><i class='fa fa-refresh fa-lg' aria-hidden='true'></a></center>";
	$renglon = "
	{
