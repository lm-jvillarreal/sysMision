...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="concentrado_caducidades.php"><i class="fa fa-bars"></i> <span>Concentrado</span></a></li>
        <li><a href="caducidades_resumen.php"><i class="fa fa-bars"></i> <span>Resumen Caducidades</span></a></li>
        <li class="active"><a href="caducidades_vencidas.php"><i class="fa fa-bars"></i> <span>Caducidades Vencidas</span></a></li>
      </ul>
      <ul class="sidebar-menu" data-widget="tree">
