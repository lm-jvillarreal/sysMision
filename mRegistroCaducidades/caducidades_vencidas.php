...
<body class="hold-transition skin-red sidebar-mini">
	<div class="wrapper">
			...
			<section class="content">
				<div class="box box-danger">
					<div class="box-header">
						<h3 class="box-title">Control de Consumo Preferente | Lista de Caducidades Vencidas</h3>
					</div>
					<div class="box-body">
						<div class="row">
							<div class="col-md-12">
		...
		<?php include 'modal_movimientos.php'; ?>
	...
	<script>
		...
		$(document).ready(function(e) {
			$('#modal-movimientos').on('show.bs.modal', function(e) {
				$('#tabla').html("<h2>Cargando registros, espere por favor ...</h2>");
				var codigo = $(e.relatedTarget).data().codigo;
				var fecha = $(e.relatedTarget).data().fecha;
				var sucursal = $(e.relatedTarget).data().suc;
				//alert(id);
