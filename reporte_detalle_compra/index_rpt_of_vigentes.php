    ...
    <section class="content">
        <div class="box box-danger">
          <div class="box-header">
            <h3 class="box-title">Reportes | Ofertas Vigentes</h3>
          </div>
          <div class="box-body">
            <form method="POST" id="form_datoss" action="reportes/rpt_ofertas_margen.php">
            <div class="row">
              <div class="col-md-3">
              ...
              <div class="col-lg-3">
                <div class="form-group">
                  ...
                  <select name="departamento" class= "select2" id="cmbDpto" required >
                      <option selected disabled>Selecciona un departamento</option>
                    <?php
                          $qry = "SELECT * FROM COM_FAMILIAS WHERE FAMN_NIVEL = '1'";
                          $stm = oci_parse($conexion_central, $qry);
                          oci_execute($stm);
                                 while ($row_suc=oci_fetch_row($stm))
                                   {
                                     echo "<option value='$row_suc[1]'>$row_suc[2]</option>";
                                   }
                    ?>
                    </select>
                </div>
