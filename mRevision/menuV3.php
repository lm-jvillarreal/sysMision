...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class=""><a href="index.php"><i class="fa fa-bars"></i> <span>Registro de Productos</span></a></li>
        <li class=""><a href="procesadas.php"><i class="fa fa-bars"></i> <span>Productos en Proceso</span></a></li>
        <li class="active"><a href="liberados.php"><i class="fa fa-bars"></i> <span>Productos Liberados</span></a></li>
      </ul>
      <ul class="sidebar-menu" data-widget="tree">
