      ...
      <section class="content">
        <div class="box box-danger">
          <div class="box-header">
            <h3 class="box-title">Reporte | Pasivos por Documentar</h3>
          </div>
          <div class="box-body">
            <form method="POST" id="form_datoss" action="reportes/rpt_comprobantes_cheques.php">
              <div class="row">
                <div class="col-md-3">
        ...
        <div class="box box-danger">
          <div class="box-header">
            <h3 class="box-title">Pasivos por documentar | Listado</h3>
          </div>
          <div class="box-body">
            <div class="row">
              <div class="col-md-12">
