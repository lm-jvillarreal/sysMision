            ...
            <form method="POST" id="form_datos">
              <div class="row">
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <div class='input-group' id='datetimepicker_inicio'>
                      <input type='time' class="form-control" id="fecha_inicio" name="fecha_inicio" style=" width:260px" onchange="diferencia()" value="<?php echo $hora ?>" />
                    </div>
                  </div>
                </div>  
              </div>
              <div class="row">
                <div class="col-md-3">
                  <div class="form-group">
                    <label>*Hora Fin:</label>
                    <div class='input-group' id='datetimepicker_fin'>
                      <input type='time' class="form-control" id="fecha_fin" name="fecha_fin" style=" width:260px" onchange="diferencia()" value="<?php echo $hora ?>" />
                    </div>
                  </div>
                </div>
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" name="tiempo" id="tiempo" class="form-control" style="width: 260px" readonly>
                  </div>
                </div>
                <div class="col-md-3">
                  <div class="form-group">
  ...
  <script>
    function cargar_tabla() {
      ...
      $('#lista_extras').DataTable({
        ...
        "ajax": {
          "type": "POST",
          "url": "http://200.1.1.197/SMPruebas/mTiempoExtra/tabla_tiempo2.php",
          "dataSrc": ""
        },
        "columns": [
          {"data": "id"},
