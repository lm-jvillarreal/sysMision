    ...
    //Insertar nuevo registro
        if(empty($motivoOtro)){
          $cadena_insertar = "INSERT INTO tiempo_extra (nombre,
            ...
            motivo,
            motivoOtro)
            VALUES('$nombre','$departamento','$sucursal','$hora_inicio','$hora_final', '$tiempo','$comentario','$fecha','$hora', '1', '$id_usuario', '1','$fecha_inicio','$fecha_final','$motivo',null)";
      ...
      motivo,
      motivoOtro)
      VALUES('$nombre','$departamento','$sucursal','$hora_inicio','$hora_final', '$tiempo','$comentario','$fecha','$hora', '1', '$id_usuario', '1','$fecha_inicio','$fecha_final','$motivo','$motivoOtro')";
