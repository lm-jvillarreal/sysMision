...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="index.php"><i class="fa fa-bars"></i> <span>Remisiones</span></a></li>
        <li class="active"><a href="bitacora.php"><i class="fa fa-bars"></i> <span>Bitácora de remisiones</span></a></li>
      </ul>
      <ul class="sidebar-menu" data-widget="tree">
