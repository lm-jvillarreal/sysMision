...
$cadenaRemision="SELECT
                  ...
                  ESTATUS_REMISION,
                  PROC_PROVEEDOR,
                  (SELECT nombre_usuario FROM usuarios WHERE id=inv_remisiones.usuario)
                  FROM
                  inv_remisiones WHERE DATE_FORMAT(FECHAHORA, '%Y-%m-%d')='$fechahora'".$filtro_sucursal;
