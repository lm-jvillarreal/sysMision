...
$cadenaCancelar="UPDATE inv_remisiones SET ESTATUS_REMISION=' 4', MOTIVO_CANCELACION='NO APLICA', USUARIO_CANCELA='$id_usuario', FECHAHORA_CANCELA='$fechahora' WHERE ID='$id_remision'";
