...
$cadena_consulta = "SELECT id, id_orden, no_orden, tipo_orden, no_factura, id_sucursal, DATE_FORMAT(fecha_elaboracion, '%d/%m/%Y'), total_diferencia, transportista, total_diferencia, bodeguero FROM carta_faltante WHERE id='$id_orden_compra'";
...
$html = "En caso de ser Carta Sobrante, el monto aquí impreso se aplica como descuento administrativo creando el folio interno de ______ el cual se descontará en su próximo pago.";
$pdf->SetY(215);
$pdf->writeHTML($html, true, false, true, false, 'J');
