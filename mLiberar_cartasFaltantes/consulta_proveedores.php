...
if(!isset($_POST['searchTerm'])){ 
  ...
  $cadena_proveedores = "SELECT PR.PROC_CVEPROVEEDOR, CONCAT(CONCAT(PR.PROC_CVEPROVEEDOR,'' ), PR.PROC_NOMBRE) FROM CXP_PROVEEDORES pr WHERE PR.PROC_NOMBRE like '%".$search."%'";
} 
