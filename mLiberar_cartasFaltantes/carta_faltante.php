...
$id_sucursal = $row_orden_compra[6];
$no_factura = $row_orden_compra[7];
$nombre_sucursal = $row_orden_compra[8];
$nombre_transportista = $row_orden_compra[9];
$total_diferencia = $row_orden_compra[10];
?>
<!DOCTYPE html>
<html>
  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        <form action="actualizar_detalle_faltante.php" method="POST" id="form-datos">
          <div class="row">
            <div class="col-md-12">
              <div class="box box-danger">
                <div class="box-header">
                  <h3 class="box-title">Cartas Fantantes | Detalle Carta Faltante</h3>
                </div>
                <div class="box-body">
                  <div class="row">
                    <div class="col-md-12">
              ...
              <div class="box box-danger">
                ...
                <div class="box-body">
                  <div class="row">
                    ...
                    <div class="col-md-2">
                      <label for="costo_unitario">C.U.</label>
                    </div>
                    <div class="col-md-2">
                      <label for="costo_total">C.T.</label>
                    </div>
                  </div>
                  <?php
                    ...
                    <div class="row">
                      <div class="col-md-2">
                        <div class="form-group">
                          ...
                          <input type="number" name="cantidad[]" id="cantidad<?php echo $row_detalle[0] ?>" class="form-control" value="<?php echo $row_detalle[1] ?>" onkeyup="total_renglon(<?php echo $row_detalle[0] ?>);" readonly>
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                          <input type="text" name="descripcion[]" id="descripcion" class="form-control" value="<?php echo $row_detalle[2] ?>" readonly>
                        </div>
                      </div>
                      <div class="col-md-2">
                        <div class="form-group">
                      ...
                      <div class="col-md-2">
                        <div class="form-group">
                          <input type="number" step="any" name="costo_unitario[]" id="costo_unitario<?php echo $row_detalle[0] ?>" class="form-control" value="<?php echo $row_detalle[4] ?>" onkeyup="total_renglon(<?php echo $row_detalle[0] ?>);">
                        </div>
                      </div>
                      <div class="col-md-2">
                        <div class="form-group">
                          <input type="number" step="any" name="total_renglon[]" id="costo_total<?php echo $row_detalle[0] ?>" value="<?php echo $row_detalle[5] ?>" class="form-control" readonly>
                        </div>
                      </div>
                    </div>
                  <?php
                  ...
                  <div class="row">
                    <div class=" col-md-2 col-md-offset-8 text-right">
                      <label for="">Total Carta:</label>
                    </div>
                    <div class="col-md-2">
                      <input type="number" step="any" class="form-control" name="total_carta" id="total_carta" value="<?php echo $total_diferencia; ?>">
                    </div>
                  </div>
                </div>
