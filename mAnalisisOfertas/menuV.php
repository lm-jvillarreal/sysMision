...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="index.php"><i class="fa fa-bars"></i> <span>Registro de codigos</span></a></li>
        <li><a href="lista_folios.php"><i class="fa fa-bars"></i> <span>Registro de Folios</span></a></li>
      </ul>
      <ul class="sidebar-menu" data-widget="tree">
