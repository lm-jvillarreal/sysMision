...
<?php include '../footer.php'; include 'modal.php'; include 'modal_material_pedido.php'; include 'modal_bodega.php';?>
   ...
   cargar_tabla();
    ...
    $("#guardar_modal").click(function(){
      ...
      $.ajax({
        type: "POST",
        url: url,
        data: {'material':material, 'cantidad':cantidad}, // Adjuntar los campos del formulario enviado.
        success: function(respuesta)
        {
          if(respuesta == "ok"){
