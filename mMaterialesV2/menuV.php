...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="index.php"><i class="fa fa-meetup"></i> <span>Catalogo de Materiales</span></a></li>
        ...
        <li class=""><a href="bitacorap.php"><i class="fa fa-history"></i> <span>Bitacora de Pedidos</span></a></li>
        <li class=""><a href='#' data-id = '' data-toggle = 'modal' data-target = '#modal-bodega' target='blank'><i class="fa fa-bold"></i> <span>Registro de Tipo de Bodega</span></a></li>
      </ul>
      <ul class="sidebar-menu" data-widget="tree">
