<?php
	...
	if($id_bodega != 0){
		$filtro = " AND NOT EXISTS (SELECT NULL FROM detalle_tbodega_encargados WHERE detalle_tbodega_encargados.encargado = usuarios.id AND detalle_tbodega_encargados.id_bodega = '$id_bodega' AND detalle_tbodega_encargados.activo= '1')";
	}else{
		$filtro = "";
	}
