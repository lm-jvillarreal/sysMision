...
$finaliza_solicitud = date("Y-m-d H:i:s");
...
$cadena_solicitar = "UPDATE solicitud_etiquetas SET estatus = '1', activo='1', finaliza_solicitud = '$finaliza_solicitud' WHERE id = '$id_solicitud[0]'";
$consulta_solicitud = mysqli_query($conexion, $cadena_solicitar);

$call = "CALL sp_select_auditoria_analisis(".$id_solicitud[0].")";
...
if($row[0] == "" && $row[1] == ""){
	...
	// }else{
	    ...
	    $cadena_eventos = mysqli_query($conexion,"SELECT usuarios.id,usuarios.nombre_usuario
	                        ...
	                        WHERE personas.id_sede = '$id_sede' AND usuarios.id_perfil = '2' OR usuarios.id = '2'");
