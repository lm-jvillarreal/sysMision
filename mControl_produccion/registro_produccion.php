      ...
      <form action="" method="POST" id="form-catalogo">
        <div class="box box-danger">
          <div class="box-header">
            <h3 class="box-title">Control de Producción | Registro de Producción</h3>
          </div>
          <div class="box-body">
            <div class="row">
              <div class="col-md-4">
        ...
        <div class="box box-danger">
                  ...
                  <table id="lista_codigos" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    <thead>
                      <tr>
                        ...
                        <th>Descripción</th>
                        <th width="10%">Cant. Solicitada</th>
                        <th width="10%">Cant. producida</th>
                      </tr>
                    </thead>
                    <tfoot>
                      <tr>
          ...
          <div class="box-footer text-right">
            <button class="btn btn-warning" id="btn-mermar" disabled="disabled">Guardar producción</button>
          </div>
        </div>
      <!-- /.row -->
    </section>
