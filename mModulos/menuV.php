...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="index.php"><i class="fa fa-bars"></i> <span>Registro de Módulos</span></a></li>
        <li class=""><a href="ayuda_modulo.php"><i class="fa fa-bars"></i> <span>Ayuda Módulos</span></a></li>
        <li class=""><a href="cambiar_categoria.php"><i class="fa fa-bars"></i> <span>Cambiar Categoría</span></a></li>
      </ul>
      <ul class="sidebar-menu" data-widget="tree">
