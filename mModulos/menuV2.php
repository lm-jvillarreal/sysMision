...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class=""><a href="index.php"><i class="fa fa-bars"></i> <span>Registro de Módulos</span></a></li>
        <li class="active"><a href="ayuda_modulo.php"><i class="fa fa-bars"></i> <span>Ayuda Módulos</span></a></li>
