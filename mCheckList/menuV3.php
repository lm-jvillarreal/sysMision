...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class=""><a href="index.php"><i class="fa fa-pencil"></i> <span>Registro de Check-List</span></a></li>
        <li class=""><a href="actividades.php"><i class="fa fa-list"></i> <span>Actividades del Check-List</span></a></li>
        <li><a href='#' data-id = '1' data-toggle = 'modal' data-target = '#modal-default3' target='blank'><i class="fa fa-list"></i><span>Registro de Sub-Departamentos</span></a></li>
        <li class="active"><a href="reporte_pchecklist.php"><i class="fa fa-clipboard"></i> <span>Reporte por Check-List</span></a></li>
        <li class="active"><a href="reporte_psubdep.php"><i class="fa fa-clipboard"></i> <span>Reporte por Sub-Departamento</span></a></li>
        <li class="active"><a href="reporte_pact.php"><i class="fa fa-clipboard"></i> <span>Reporte por Actividad</span></a></li>
      </ul>
      <ul class="sidebar-menu" data-widget="tree">
