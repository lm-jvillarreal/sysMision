    ...
    <section class="content">
        <div class="box box-danger" <?php echo $solo_lectura?>>
          ...
          <div class="box-header">
            <h3 class="box-title">Reporte por Sub-Departamento</h3>
          </div>
          <div class="box-body">
            <div class="row">
              <div class="col-md-12">
   ...
   function cargar_tabla() {
    ...
    $('#lista_checklist').DataTable( {
      'language': {"url": "../plugins/DataTables/Spanish.json"},
        ...
        buttons: [{
          ...
          },
          {
            ...
            className: 'btn btn-default',
            title: 'Reporte por SubDepartamento',
            exportOptions: {
              columns: ':visible'
            }
          },
      ...
      "columns": [
        { "data": "#" , "width": "3%"},
        { "data": "Departamento" },
        { "data": "Muestreo" , "width": "5%"},
        { "data": "Efectividad", "width": "5%" },
      ]
    });
  } 
