...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="actividades.php"><i class="fa fa-list"></i> <span>Actividades del Check-List</span></a></li>
        <li class="hidden" id="menu_programacion_multiple"><a href='#' data-id = '1' data-toggle = 'modal' data-target = '#modal-default4' target='blank'><i class="fa fa-calendar"></i> <span>Programacion Multiple</span></a></li>
