...
<section class="sidebar">
  ...
  <ul class="sidebar-menu" data-widget="tree">
    ...
    <li class="active"><a href="index.php"><i class="fa fa-clock-o"></i> <span>Actividades Propias</span></a></li>
    <li class="active"><a href="actividades.php "><i class="fa fa-list-alt"></i> <span>Bitacora de Actividades</span></a></li>
    <li class="active"><a href="actividades_usuario.php"><i class="fa fa-list-alt"></i> <span>Actividades por Usuario</span></a></li>
