...
?>
   <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="index.php"><i class="fa fa-ticket"></i> <span>Tunos</span></a></li>
        <li ><a href="../mFarmacia/index.php"><i class="fa fa-check"></i> <span>Surtir Receta</span></a></li>
      </ul>
      <ul class="sidebar-menu" data-widget="tree">
