...
if(!isset($_POST['searchTerm'])){ 
  $cadena_departamentos = "SELECT * FROM COM_FAMILIAS WHERE FAMN_NIVEL = '1'";
}else{ 
  $search = $_POST['searchTerm'];   
  $cadena_departamentos = "SELECT * FROM COM_FAMILIAS WHERE FAMN_NIVEL = '1' AND FAMC_DESCRIPCION like '%".$search."%'";
} 
