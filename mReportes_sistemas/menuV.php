...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="index.php"><i class="fa fa-bars"></i> <span>R. Cambio de precios con folio</span></a></li>
        <li class="active"><a href="index_rpt_cambio_precios_dpto.php"><i class="fa fa-bars"></i> <span>R. Cambio de precios por departamento</span></a></li>
        <li class="active"><a href="index_rpt_cambio_precios_dpto2.php"><i class="fa fa-bars"></i> <span>R. Cambio de precios dpto 2</span></a></li>
        <li class="active"><a href="index_immex.php"><i class="fa fa-bars"></i> <span>R. IMMEX</span></a></li>
