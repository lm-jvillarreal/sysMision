<?php 
	...
	for ($i=0; $i < count($cantidad); $i++) { 
		$sql = "INSERT INTO renglones_referencia (id_referencia, codigo, total, descripcion, c_do, c_vil, c_arb, c_all, c_total,diferencia) VALUES('$row[0]', '$codigo[$i]', '$cantidad[$i]', '$descripcion[$i]', '$c_do[$i]', '$c_vil[$i]', '$c_arb[$i]', '$c_all[$i]', '$c_total[$i]','$c_diff[$i]')";
