...
$fecha = date('Y-m-d');
$hora = date('H:i:s');
$fecha_inicio = $_POST['fecha_inicial_SIS004'];
$fecha_i=str_replace("-","",$fecha_inicio);
//$fecha_i=trim($fecha_inicio, "-");
$fecha_final = $_POST['fecha_final_SIS004'];
...
$consulta_principal  = "SELECT
	...
	//Rename worksheet
	$objPHPExcel->getActiveSheet()->setTitle('IMMEX');
	...
	header('Content-Disposition: attachment;filename="rpt_immex_ '.$fecha.' .xlsx"');
