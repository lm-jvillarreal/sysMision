...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="index.php"><i class="fa fa-bars"></i> <span>Catálogo de Conversiones</span></a></li>
        <li class="active"><a href="captura.php"><i class="fa fa-bars"></i> <span>Captura</span></a></li>
        <li class="active"><a href="produccion.php"><i class="fa fa-bars"></i> <span>Producción</span></a></li>
