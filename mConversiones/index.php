    ...
    <body class="hold-transition skin-red sidebar-mini">
      <div class="wrapper">
        ...
        <div class="content-wrapper">
          ...
          <section class="content">
                  ...
                  <div class="row">
                    <div class="col-md-3">
                      <div class="form-group">
                        ...
                        <select name="conversion" id="conversion" class="form-control select2" style="width: 230px">
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                        ...
                        <div class="input-group">
                          <input type="text" name="medida" id="medida"class="form-control" placeholder="Ejemplo: Costal" style="width: 250px" >
                        </div>
                      </div>
                    </div>
                    <div class="col-md-3">
                      <div class="form-group">
                        <label>*Masa (KG)</label>
                        <div class="input-group">
                          <input type="text" name="masa" id="masa"class="form-control" style="width: 250px" >
                        </div>
                      </div>
                    </div>
                    <div class="col-md-3">
                      <div class="form-group">
                        <label>*Tortillas (KG)</label>
                        <div class="input-group">
                          <input type="text" name="tortillas" id="tortillas"class="form-control" style="width: 250px" >
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div class="box box-danger">
              <div class="box-header">
                <h3 class="box-title">Lista de Conversiones</h3>
              </div>
              <div class="box-body">
                <div class="row">
                  <div class="col-md-12">
                    <div class="table-responsive">
                      <table id="lista_conversion" class="table table-striped table-bordered" cellspacing="0" width="100%">
                        <thead>
                          <tr>
                            <th width="5%">ID</th>
                            ...
                            <th width="15%">Masa</th>
                            <th width="15%">Tortillas</th>
                            <th width="15%">Masa/Tortillas</th>
                          </tr>
                        </thead>
                        <tfoot>
                          <tr>
      ...
      <script>
        ...
        function cargar_tabla(){
          $('#lista_conversion').dataTable().fnDestroy();
          $('#lista_conversion').DataTable( {
        ...
        $.validator.setDefaults( {
          submitHandler: function () {
            ...
            $.ajax({
              ...
              url: 'insertar_conversion.php', //archivo que recibe la peticion
