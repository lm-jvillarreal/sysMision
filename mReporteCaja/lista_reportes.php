<?php
  ...
  $consulta = "SELECT reportes_cajas.id, sucursales.nombre AS SUCURSAL, cajas.nombre AS NOMBRE_CAJA,
  ( SELECT nombre FROM tipos_equipos WHERE reportes_cajas.id_equipo = tipos_equipos.id_tipo ) as Equipo,
  ...
  WHERE reportes_cajas.activo = '1' AND (reportes_cajas.status = '1' OR reportes_cajas.status = '2') GROUP BY SUCURSAL";
          ...
          <section class="content">
            <div class="box box-danger">
              <div class="box-header">
                <h3 class="box-title">Lista de Reportes Revisados</h3>
                <br>
              </div>
              <div class="box-body">
                <div class="row">
    ...
    <script>
        function cargar_tabla() {
          ...
          $('#lista_reportes').DataTable( {
            ...
            "ajax": {
              "type": "POST",
              "url": "tabla_reportes_revisados.php",
              "dataSrc": "",
        ...
        function liberar(id){
            $.ajax({
                ...
                success: function(respuesta) {
                    if(respuesta == "ok"){
                        alertify.success('Reporte Liberado');
                        cargar_tabla();
                    }
                    else{
