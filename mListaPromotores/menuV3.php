...
<section class="sidebar">
  ...
  <ul class="sidebar-menu" data-widget="tree">
    ...
    <li class=""><a href="index.php"><i class="fa fa-list-alt"></i> <span>Lista Promotores</span></a></li>
    <li class="active"><a href="promotores.php"><i class="fa fa-check-circle"></i> <span>Promotores Activos</span></a></li>
  </ul>
  <ul class="sidebar-menu" data-widget="tree">
