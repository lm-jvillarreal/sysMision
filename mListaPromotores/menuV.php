<?php
  ...
  if($perfil_usuario == 2 || $perfil_usuario == 1 || $id_usuario = 106){
    $acceso = "";
  }else{
...
<section class="sidebar">
  ...
  <ul class="sidebar-menu" data-widget="tree">
    ...
    <li class="active"><a href="index.php"><i class="fa fa-list-alt"></i> <span>Lista Promotores</span></a></li>
    <li class="" <?php echo $acceso;?>><a href="promotores.php"><i class="fa fa-check-circle"></i> <span>Promotores Activos</span></a></li>
  </ul>
  <ul class="sidebar-menu" data-widget="tree">
