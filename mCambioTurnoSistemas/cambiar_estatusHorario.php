...
$cadena_modifica = "UPDATE cambio_turnoSistemas SET estatus= '$estado',autoriza='$id_usuario', autoriza = '$id_usuario' WHERE id = '$id_registro'";
$modifica_estado = mysqli_query($conexion, $cadena_modifica);

 //Consulta de datos
 $consulta_remision = mysqli_query($conexion,"SELECT empleado FROM cambio_turnoSistemas WHERE id ='$id_registro'");
