...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="index.php"><i class="fa fa-pencil"></i> <span>Cambio de Turno</span></a></li>
        <li class="active"><a href="bitacora.php"><i class="fa fa-pencil"></i> <span>Bitácora</span></a></li>
      </ul>
      <ul class="sidebar-menu" data-widget="tree">
