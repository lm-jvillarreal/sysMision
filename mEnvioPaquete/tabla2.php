...
?>
	<div class="table-responsive">
        <table id="lista2" class="table table-striped table-bordered" cellspacing="0" width="100%">
	        <thead>
	            <tr>
                    <th width="2%">#</th>
                    <th>Fecha</th>
	        ...
	        <?php 
				...
				{	
					...
					<tr>
                        ...
                        <td>
						    <center>
				                <a href="javascript:GenerarPdf2('<? echo"$row[1]"; ?>');" class='fa fa-file-pdf-o fa-3x' style="color: #DF0101;"></a>
                            </center>
						</td>
					</tr>
				<?php 
