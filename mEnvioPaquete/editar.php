  ...
  <div class="content-wrapper">
    <section class="content">
        <div class="box box-danger">
          ...
          <div class="box-body">
            <form method="POST" id="form_liberar_pedidoss">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                        <div class="form-group">
                          <label for="bodega">*Bodega</label>
                            <input  name="bodega" id="bodega" value="<?php echo "$row1[3]"; ?>" class="form-control" readonly>
                        </div>
                    </div> 
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                        <div class="form-group">
                            ...
                            while($row=mysqli_fetch_array($consulta_tabla))
                                {?>
                                    <tr>
                                        ...
                                        <td>
                                            <center><input class="form-control" type="number" style="border:none" id="pedido<?php echo $n;?>" name="pedido[]" min="0" max="999" value="<?php echo "$row[7]"; ?>" readonly></center>
                                        </td>
                                        <td>
                                            <center><input type="text" class="form-control" style="border:none" id="envio<?php echo $n;?>" name="envio[]" value="<?php echo "$row[7]"; ?>" onchange="javascript:validar2('<?php echo $n;?>',$('#codigo'+<? echo $n ?>).val(),$('#existencia'+<? echo $n ?>).val(),this.value,'<?php echo $row1[2];?>');" autofocus></center>
                                        </td>
                                    </tr>
                                 <?php 
                                 $n++;
...
<script>
  function estilo_tablas () {
      ...
      submitHandler: function () {
        var url = "update.php"; 
          $.ajax({
                 type: "POST",
                 url: url,
                 data: $("#form_liberar_pedidoss").serialize(),
    ...
    $( document ).ready( function () {
      $( "#form_liberar_pedidoss" ).validate( {
        rules: {
          bodega: "required"
        },
        messages: {
