	        ...
	        <?php 
				...
				{	
					...
					<tr>
                        ...
                        <td>
						    <center>
				                <a href="javascript:liberar('<? echo"$row[1]"; ?>');" class='fa fa-check-circle fa-3x' style="color: #DF0101;"></a>
                            </center>
						</td>
                        <td>
                            <center>
                                <a href="javascript:eliminar('<? echo"$row[1]"; ?>');" class='btn btn-danger'>Eliminar</a>
                            </center>
                        </td>
					</tr>
				<?php 
