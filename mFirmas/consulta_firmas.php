...
if(!isset($_POST['searchTerm'])){ 
  $cadena_sucursales = "SELECT id, nombre FROM firmas_autorizadas WHERE activo = '1'";
}else{ 
  $search = $_POST['searchTerm'];   
  $cadena_sucursales = "SELECT id, nombre FROM firmas_autorizadas WHERE activo = '1' AND nombre like '%".$search."%'";
} 
