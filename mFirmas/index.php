                  ...
                  <div class="row">
                    <div class="col-md-3">
                      <div class="form-group">
                        ...
                        <select id="permisos" name="permisos[]" multiple class="select" style="width:100%"></select>
                      </div>
                    </div>
                    <div class="col-md-3">
                      <div class="form-group">
...
<script>
      ...
      $('#id_persona').select2({
        ...
        ajax: {
          ...
          data: function(params) {
            return {
              searchTerm: params.term // search term  http://200.1.1.197/SMPruebas/mTiempoExtra/
            };
          },
  ...
  function llenar() {
      ...
      if (id_persona != "") {
        ...
        $.ajax({
          ...
          success: function(respuesta) {
            //evaluar el array y separarlo para imprimir por campos   http://200.1.1.197/SMPruebas/mTiempoExtra/
  ...
  function estatus(registro){
    ...
    var url = 'cambiar_estado_firmas.php';
    $.ajax({
      url: url,
      type: "POST",
      dateType: "html",
  ...
  $('#modal-default').on('show.bs.modal', function(e) {
       ...
       var url = "consulta_datos_modal.php"; // El script a dónde se realizará la petición.http://200.1.1.197/SMPruebas/mFirmas/
        $.ajax({
          type: "POST",
          url: url,
