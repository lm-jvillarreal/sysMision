...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="index.php"><i class="fa fa-bars"></i> <span>Registro de firmas</span></a></li>
        <li class="active"><a href="lista_firmas.php"><i class="fa fa-bars"></i><span>Lista de Firmas Autorizadas</span></a></li>
        <li class="active"><a href="alta_permisos.php"><i class="fa fa-bars"></i><span>Registro de Permisos</span></a></li>
