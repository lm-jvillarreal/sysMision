...
$cadena  = "SELECT fa.id, fa.nombre, fa.departamento, fa.sucursal, fa.puesto, p.nombre as permiso, fa.id_permiso, fa.activo FROM firmas_autorizadas AS fa 
