    ...
    <section class="content">
        <div class="box box-danger">
          <div class="box-header">
            <h3 class="box-title">Visualizacion de Efectivos</h3>
          </div>
          <div class="box-body">
            <form action="reporteexcel_efectivos.php">
            <div class="row">
              <div class="col-md-6">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-group date form_date" data-date="<?php echo $fecha ?>" data-date-format="yyyy-mm-dd" data-link-field="fecha_final" data-link-format="yyyy-mm-dd">
                    ...
                    <!-- onchange="habilitar(($('#fecha_inicio').val()),(this.value))" -->
                    <span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
                    <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
                  </div>
                </div>
            ...
            <div class="box-footer text-right">
              ...
              <button type="submit" class="btn btn-warning" id="excel">Generar Excel</button>
          </form>
          </div>
        </div>
        <div class="box box-danger">
          <div class="box-header">
            <h3 class="box-title">Efectivos (Resumen)</h3>
          </div>
          <div class="box-body">
            <div class="row">
        ...
        <div class="box box-danger">
          <div class="box-header">
            <h3 class="box-title">Otros (Resumen)</h3>
          </div>
          <div class="box-body">
            <div class="row">
              <div class="col-md-12" id="tabla">
                <div class="table-responsive">
                  <table id="lista_otros" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    <thead>
                      <tr>
                        <th width="5%">#</th>
                        <th>Folio</th>
...
<script>
  function verificar(fecha_inicio,fecha_final) {
    ...
    else
    {
      ...
      {
        cargar_tabla(fecha_inicio,fecha_final);
        cargar_tabla_otros(fecha_inicio,fecha_final);
      }
    }
  }
</script>
<script>
  function cargar_tabla_otros(fecha_inicio,fecha_final) {
    $('#lista_otros').dataTable().fnDestroy();
    $('#lista_otros').DataTable( {
...
<script>
  function cargar_tabla(fecha_inicio,fecha_final) {
