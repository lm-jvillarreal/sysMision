...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="index.php"><i class="fa fa-bars"></i> <span>Efectivos</span></a></li>
        <li ><a href="faltantes.php"><i class="fa fa-bars"></i> <span>Faltantes Morralla</span></a></li>
      </ul>
      <ul class="sidebar-menu" data-widget="tree">
