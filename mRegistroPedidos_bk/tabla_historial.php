...
$cadenaPedido = "SELECT ID, 
                  ...
                  AND ESTATUS_SURTIDO='3'";
$consultaPedido = mysqli_query($conexion,$cadenaPedido);

$cuerpo="";
while($rowPedido=mysqli_fetch_array($consultaPedido)){
  $link = "<center><a href='#' onclick='tabla_resumen($rowPedido[0])' class='btn btn-primary'><i class='fa fa-search fa-lg' aria-hidden='true'></i></a></center>";
  if($rowPedido[6]=='1'){
