...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="index.php"><i class="fa fa-bars"></i> <span>Listado tareas</span></a></li>
        <li><a href="control_preventivos.php"><i class="fa fa-bars"></i> <span>Control de preventivos</span></a></li>
      </ul>
      <ul class="sidebar-menu" data-widget="tree">
