...
$cadena_ordenes = "SELECT numero_nota, id, activo, tipo, orden_compra FROM libro_diario as le WHERE (le.fecha >= '$fecha_inicial' AND le.fecha <= '$fecha_final') AND sucursal = '$sucursal' ORDER BY le.numero_nota ASC";
//echo $cadena_ordenes;
