...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="index.php"><i class="fa fa-bars"></i> <span>Conciliación de Libro</span></a></li>
        <li class="active"><a href="resumen_conciliacion.php"><i class="fa fa-bars"></i> <span>Resumen</span></a></li>
      </ul>
      <ul class="sidebar-menu" data-widget="tree">
