          ...
          <div class="box-body">
            <form method="POST" id="form_datos">
              <div class="row">
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    <label>*Añadir Días:</label>
                    <input type="text" name="dias" id="dias" class="form-control" placeholder="Añadir Días">
                  </div>
                </div>
              </div>
        ...
        <div class="box box-danger" id="parte2" style="display: none;">
          ...
          <div class="box-body">
            <form id="form_datos2" method="POST">
              ...
              <div class="box-footer text-right">
                <button type='button' id='eliminar_todo' class="btn btn-danger">Eliminar Todos los Registros</button>
  ...
  <script>
    ...
    function abrir() {
      ...
      $.ajax({
        ...
        success: function(respuesta) {
          $('#dias').prop('placeholder', respuesta);
        }
      });
