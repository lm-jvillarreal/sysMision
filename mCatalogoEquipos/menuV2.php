...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="index.php"><i class="fa fa-bars"></i> <span>Registro de Equipos</span></a></li>
        <li class="active"><a href="lista_equipos.php"><i class="fa fa-bars"></i> <span>Catálogo de Equipos</span></a></li>
      </ul>
      <ul class="sidebar-menu" data-widget="tree">
