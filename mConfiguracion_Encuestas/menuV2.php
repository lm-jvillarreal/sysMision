    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="cuestionario.php"><i class="fa fa-bars"></i> <span>Cuestionarios</span></a></li>
        <li class=""><a href="resultados.php"><i class="fa fa-bars"></i> <span>Resultados</span></a></li>
      </ul>
      <ul class="sidebar-menu" data-widget="tree">
