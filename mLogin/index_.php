...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../d_plantilla/plugins/slick/slick.css" />
    <link rel="stylesheet" type="text/css" href="../d_plantilla/plugins/slick/slick-theme.css" />
...
<body>
    <div class="container-fixed">
        <div class="row">
            ...
            <div class="col-md-6">
                <div id="modal" class="custom-modal fade in" tabindex="-1" role="dialog" aria-labelledby="modal" data-keyboard="false" style="display: block;">
    ...
    <script src="../d_plantilla/plugins/slick/slick.min.js"></script>
    <script>
