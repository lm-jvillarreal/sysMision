...
$cadena_validar = "SELECT MAX(id) FROM formatos_movimientos WHERE tipo_movimiento = 'SFCBOT' AND activo = '1' AND sucursal = '$id_sede'";
...
$pdf->SetTitle('Transferencia Botiquín.');
...
$html="
<br><br>
<h2 style='text-align:center;'>TRANSFERENCIA PARA FARMACIA BOTIQUÍN</h2>
";
