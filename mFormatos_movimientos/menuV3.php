...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class=""><a href="index.php"><i class="fa fa-bars"></i> <span>Impresión de Formatos</span></a></li>
        <li><a href="resumen.php"><i class="fa fa-bars"></i> <span>Resumen</span></a></li>
        <li  class="active"><a href="bitacora_movimientos.php"><i class="fa fa-bars"></i> <span>Bitácora</span></a></li>
      </ul>
      <ul class="sidebar-menu" data-widget="tree">
