...
$cadena_validar = "SELECT MAX(id), nombre_solicita FROM formatos_movimientos WHERE tipo_movimiento = 'SXMFTA' AND activo = '1' AND sucursal = '$id_sede' group by id order by id desc limit 1";
...
$html="
<br><br>
<h2 style='text-align:center;'>MERMA FRUTAS Y VERDURAS</h2>
";
