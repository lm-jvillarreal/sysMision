...
$cadena_validar = "SELECT MAX(id) FROM formatos_movimientos WHERE tipo_movimiento = 'TRADEP' AND activo = '1' AND sucursal = '$id_sede'";
...
$html="
<br><br>
<h2 style='text-align:center;'>TRANSFERENCIA ENTRE DEPTOS.</h2>
";
