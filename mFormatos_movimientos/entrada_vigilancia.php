...
$cadena_validar = "SELECT MAX(id), nombre_solicita FROM formatos_movimientos WHERE tipo_movimiento = 'EXVIGI' AND activo = '1' AND sucursal = '$id_sede' group by id order by id desc limit 1";
...
$pdf->SetTitle('Entrada Vigilancia');
...
$html="
<br><br>
<h2 style='text-align:center;'>FORMATO DE MERCANCÍA OLVIDADA<br>ENTRADA POR VIGILANCIA</h2>
";
...
<table border=\"0\" align=\"center\">
	<tr>
        <td><br><br>____________________________<br>SISTEMAS</td>
        <td><br><br>____________________________<br>VIGILANCIA</td>
		<td align = \"center\" rowspan=\"2\"><br><br>____________________________<br>GERENCIA</td>
	</tr>
	<tr>
		<td colspan=\"2\">
