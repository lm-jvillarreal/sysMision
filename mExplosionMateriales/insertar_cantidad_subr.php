...
if($rowExiste[0] > 0){
  $consulta_modifica = "UPDATE panaderia_invpro_cantidad SET CANTIDAD = '$cantidad', USUARIO = '$id_usuario' WHERE ID_ARTICULO = '$id_articulo'";
  $cadena_modifica = mysqli_query($conexion, $consulta_modifica);
  echo "ok_modifica";
}else{
   $cadena_insertar = "INSERT INTO panaderia_invpro_cantidad (ID_ARTICULO,CANTIDAD,TIPO, FECHA,HORA, ACTIVO, USUARIO)
  VALUES('$id_articulo','$cantidad','2','$fecha','$hora', '1', '$id_usuario')";
