...
<body class="hold-transition skin-red sidebar-mini">
			...
			<section class="content">
				<div class="box box-danger">
					<div class="box-header">
						<h3 class="box-title">Explosión de materiales | Inventarios y producción: Recetas</h3>
					</div>
					<div class="box-body">
						<div class="row">
							<div class="col-md-12">
									...
									<table id='lista_articulos' class='table table-striped table-bordered' cellspacing='0' width='100%'>
										<thead>
											<tr>
												...
												<th width='15%'>Proyección de venta en Unidades</th>
	...
	<!-- ./wrapper -->
	<?php include 'modal_produccion.php'; ?>
    <?php include 'modal_carga.php'; ?>
...
$(document).ready(function(e) {
        ...
        function cargar_tabla() {
            ...
            $('#lista_articulos').DataTable({
                ...
                "ajax": {
                    "type": "POST",
                    "url": "tabla_inventarios_produccion.php",
                    "dataSrc": "",
                    "data": ""
                },
                "columns": [{
		...
		$('#modal-produccion').on('show.bs.modal', function(e){
            $(".modal-dialog").css("width", "50%");
            var idreg = $(e.relatedTarget).data().idreg;
            var idprod = $(e.relatedTarget).data().idprod;
            var url = "consulta_modal_prod.php"; //por crear
            $.ajax({
                type: "POST",
                url: url,
                data:{
        ...
        $('#btn-Guardar').click(function() {
            if ($("#cantidad_prod").val() == "") {
                ...
                var url = "insertar_cantidad_prod.php";//por crear
                $.ajax({
                    url:url,
                    type:"POST",
                    dataType:"html",
            ...
            if (val == "") {
                ...
                $.ajax({
                    ...
                    success:function (respuesta) {
                        ...
                        $('#lista_articulos').DataTable().ajax.reload(/*async () => {
