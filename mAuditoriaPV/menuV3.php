...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="lista_folios.php"><i class="fa fa-bars"></i> <span>Listado de folios</span></a></li>
        <li><a href="lista_proveedor.php"><i class="fa fa-bars"></i> <span>Lista Proveedor</span></a></li>
      </ul>
      <ul class="sidebar-menu" data-widget="tree">
