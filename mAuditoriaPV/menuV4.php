...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="index.php"><i class="fa fa-bars"></i> <span>Auditoría PV</span></a></li>
        <li><a href="lista_registros.php"><i class="fa fa-bars"></i> <span>Listado</span></a></li>
        <li><a href="lista_folios.php"><i class="fa fa-bars"></i> <span>Listado de folios</span></a></li>
        <li class="active"><a href="lista_proveedor.php"><i class="fa fa-bars"></i> <span>Lista Proveedor</span></a></li>
      </ul>
      <ul class="sidebar-menu" data-widget="tree">
