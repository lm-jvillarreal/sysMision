    ...
    <section class="content">
        <div class="box box-danger" <?php echo $solo_lectura?>>
          <div class="box-header">
            <h3 class="box-title">Reporte Salidas | Filtros</h3>
          </div>
          <div class="box-body">
            <div class="row">
              <div class="col-md-3">
              ...
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  <select name="sucursal2" id="sucursal2" class="form-control" style="width:100%"></select>
                </div>
              </div>
              <div class="col-md-3">
                <div class="form-group">
  ...
  function cargar_tabla(){
    ...
    $('#lista_existencia').DataTable( {
      ...
      "ajax": {
        ...
        "url": "tabla3.php",
        "dataSrc": "",
        "data":{'fecha1':fecha1, 'fecha2':fecha2, 'sucursal2':sucursal2,'sucursal':sucursal, 'familia':familia,'articulo':articulo}
      },
      "columns": [
        { "data": "#", "width":"3%" },
        { "data": "Fecha"},
