...
<section class="sidebar">
  ...
  <ul class="sidebar-menu" data-widget="tree">
    ...
    <li class="active"><a href="index.php"><i class="fa fa-clipboard"></i> <span>Reporte de Existencia</span></a></li>
    <li class="active"><a href="r_entradas.php"><i class="fa fa-clipboard"></i> <span>Reporte de Entradas</span></a></li>
    <li class="active"><a href="r_salidas.php"><i class="fa fa-clipboard"></i> <span>Reporte de Salidas</span></a></li>
    <li class="active"><a href="r_prestamos.php"><i class="fa fa-clipboard"></i> <span>Reporte de Prestamos</span></a></li>
    <li class="active"><a href="r_traspasos.php"><i class="fa fa-clipboard"></i> <span>Reporte de Traspasos</span></a></li>
    <li class="active"><a href="r_actividades.php"><i class="fa fa-clipboard"></i> <span>Reporte de Actividades</span></a></li>
  </ul>
  <ul class="sidebar-menu" data-widget="tree">
