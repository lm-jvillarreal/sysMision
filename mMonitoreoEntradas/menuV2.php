...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="index.php"><i class="fa fa-bars"></i> <span>Lista de Entradas</span></a></li>
        <li class="active"><a href="resumen_entradas.php"><i class="fa fa-bars"></i> <span>Resumen de Entradas</span></a></li>
      </ul>
      <ul class="sidebar-menu" data-widget="tree">
