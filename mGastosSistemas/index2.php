				...
				<div class="box box-danger" <?php echo $solo_lectura ?>>
					...
					<div class="box-body">
						<form method="POST" id="form_datos" enctype="multipart/form-data">
							<input type="text" id="id_gasto" name="id_gasto" value="0" class="hidden">
							<div class="row">
								<div class="col-md-3">
								...
								<div class="col-md-3">
                    				<div class="form-group">
                      					...
                      					<div class="input-group date form_date" id='datetimepicker_mov'>
                        					<input type='text' class="form-control" id="fecha_mov" name="fecha_mov" value="<?php echo $fecha ?>" />
								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<div class="input-group">
											...
											<input type="text" class="form-control" name="gasto" id="gasto">
										</div>
									</div>
								</div>
								<div class="col-md-3">
									<div class="form-group">
										...
										<select name="rublo" id="rublo" class="form-control" style="width:250px">
										</select>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-md-3">
									<div class="form-group">
										...
										<input type="text" class="form-control" name="folio_factura" id="folio_factura">
									</div>
								</div>
								<div class="col-md-3">
									<div class="form-group">
	...
	<script>
		...
		$.validator.setDefaults({
			submitHandler: function() {
				...
				var url = "insertar_gastov2.php"; // El script a dónde se realizará la petición.
				$.ajax({
					type: "POST",
					url: url,
					dataType: "html",
		...
		function cargar_tabla_gastos() {
			...
			$('#lista_gastos_guardados').DataTable({
				...
				"ajax": {
					"type": "POST",
					"url": "tabla_gastos_guardadosv2.php",
					"dataSrc": "",
					"data": ""
				},
				"columns": [{
