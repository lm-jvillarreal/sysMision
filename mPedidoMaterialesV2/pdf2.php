...
<table border="1" cellspacing="0" cellpadding="2">
    <tr style="background-color:#FF0000;color:#FFFFFF">
        ...
        <th align="center" width="10%"><b>Pedido</b></th>
        <th align="center" width="10%"><b>Surtido</b></th>
    </tr>';
$cadena = mysqli_query($conexion,"SELECT (SELECT nombre FROM catalogo_materiales2 WHERE catalogo_materiales2.id = detalle_pedido.id_material), cantidad,surtido FROM detalle_pedido WHERE activo = '1' AND id_pedido = '$id_pedido'");
$numero = 1;
while ($row=mysqli_fetch_row($cadena)) 
{
    ...
    $html .= '<tr nobr="true">
                ...
                <td nobr="true" align="center"><b>'.$row[2].'</b></td>
            </tr>';
    $numero ++;
    $imagen = "";
}
