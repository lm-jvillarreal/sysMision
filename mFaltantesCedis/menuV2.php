...
<section class="sidebar">
  ...
  <ul class="sidebar-menu" data-widget="tree">
    ...
    <li><a href="index.php"><i class="fa fa-bars"></i> <span>Crear pedido</span></a></li>
    <li class="active"><a href="auditoria_pedidos.php"><i class="fa fa-bars"></i> <span>Auditar pedido</span></a></li>
  </ul>
  <ul class="sidebar-menu" data-widget="tree">
