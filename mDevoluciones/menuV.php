...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="index.php"><i class="fa fa-bars"></i> <span>Registro</span></a></li>
        ...
        <li><a href="devoluciones_liberadas.php"><i class="fa fa-bars"></i> <span>Devoluciones Liberadas</span></a></li>
        <li><a href="grafica.php"><i class="fa fa-bar-chart"></i> <span>Grafica Devoluciones</span></a></li>
      </ul>
      <ul class="sidebar-menu" data-widget="tree">
