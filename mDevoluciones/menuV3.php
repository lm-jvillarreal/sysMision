...
?>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="index.php"><i class="fa fa-bars"></i> <span>Registro</span></a></li>
        <li><a href="devcentr.php"><i class="fa fa-bars"></i> <span>Dev. Centralizada</span></a></li>
        <li><a href="devoluciones_pendientes.php"><i class="fa fa-bars"></i> <span>Devoluciones Pendientes</span></a></li>
        <li  class="active"><a href="devoluciones_liberadas.php"><i class="fa fa-bars"></i> <span>Devoluciones Liberadas</span></a>
        <li><a href="grafica.php"><i class="fa fa-bar-chart"></i> <span>Grafica Devoluciones</span></a></li></li>
      </ul>
      <ul class="sidebar-menu" data-widget="tree">
